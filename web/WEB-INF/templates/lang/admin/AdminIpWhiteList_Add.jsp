<html>
<head>
    <title><? templates/sv/AdminIpAccess_Add.htm/9 ?></title>
                        ...
                        <form method="post" action="AdminIpWhiteList" name="addIP">
                            <table border="0" cellspacing="0" cellpadding="2" width="400">
                                <tr>
                                    <td colspan="2">
                                        <!-- gui_heading -->
                                        <span class="imcmsAdmHeading"><? templates/sv/AdminIpAccess_Add.htm/9 ?></span><br/>
                                ...
                                <tr>
                                    <td>
                                        <label for="roles-select"><? templates/sv/AdminIpAccess_Add.htm/10 ?></label>
                                    </td>
                                    <td>
                                        <select id="roles-select" name="IS_ADMIN" size="1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="IP_START" size="15" maxlength="15">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" align="right">
                                        <input type="submit" class="imcmsFormBtn" name="ADD_NEW_IP_RANGE"
