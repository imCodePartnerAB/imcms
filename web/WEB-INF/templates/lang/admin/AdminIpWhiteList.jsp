                        ...
                        <form id="white-list-form" method="post" action="AdminIpWhiteList" name="argumentForm">
                            <table border="0" cellspacing="0" cellpadding="2" width="400">
                                <tr>
                                    <td>
                                        <!-- gui_heading -->
                                        <span class="imcmsAdmHeading"><? templates/sv/AdminIpWhiteList.jsp/1 ?></span><br/>
                                    ...
                                    <td>
                                        <table border="0" cellspacing="0" cellpadding="2" width="100%">
                                            <tr>
                                                ...
                                                <td><b><? templates/sv/AdminIpWhiteList.jsp/2 ?></b></td>
                                            ...
                                            <c:forEach items="${roleIpRanges}" var="ipRange">
                                                <tr>
                                                    <td align="center"><input type="checkbox" name="EDIT_IP_RANGE_ID"
                                                                              value="${ipRange.id}"></td>
                                                    <td><c:if test="${ipRange.admin}">Superadmin</c:if> <c:if
                                                            test="${not ipRange.admin}">Other roles</c:if></td>
