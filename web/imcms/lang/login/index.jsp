...
<tr>
	...
	<img src="@imcmsimageurl@/admin/1x1.gif" width="1" height="5"><? templates/login/index.html/1001 ?></span></td>
</tr>
<tr>
	<td colspan="2">&nbsp;</td>
</tr>
<tr>
	...
	<tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input class="imcmsFormBtn" type="submit" name="Ändra" value="<? templates/login/index.html/2006 ?>" style="width:80"></td>
		</tr>
		</table></td>
	</tr>
	</form>
