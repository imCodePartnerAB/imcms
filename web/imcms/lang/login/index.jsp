...
<tr>
	...
	<tr>
		...
		<td>&nbsp;</td>
        <td><input type="button" class="imcmsFormBtn" style="width:115" value="<? templates/login/index.html/2002 ?>" onClick="top.location='<%= request.getContextPath() %>/servlet/ResetPassword';"></td>
        <td>&nbsp;</td>
