                ...
                switch ($(this).attr('id')) {
                    ...
                    case "imcms-bankid-tab":
                    {
                        ...
                        $("iframe").load(function (e) {
                            try {
                                if ($(this).get(0).contentWindow.location.href == location.protocol + '//' + location.host + "<%=request.getContextPath()+ "/StartDoc" %>") {
                                    $(this).css({display: 'none'});
                                    window.location.replace(location.protocol + '//' + location.host + "<%=request.getContextPath()+"/servlet/StartDoc" %>");
                                }
                            }
                            catch (e) {
                            }
