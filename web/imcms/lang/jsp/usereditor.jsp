...
<%@ page import="static com.imcode.imcms.services.TwoFactorService.REQUEST_PARAMETER_2FA" %>
        ...
        <script type="text/javascript">
            ...
            jQ(document).ready(function ($) {
                ...
                window.setTimeout(function () {
                    $pw1.attr('autocomplete', 'off').focus().val('');
                    <%-- FF has a bug. Ignores autocomplete=off sometimes --%>
                }, 100);
            });
    ...
    <form method="post" action="$contextPath/servlet/PageDispatcher">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="660" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__FIRST_NAME %>" size="25"
                           maxlength="25" value="<%= StringEscapeUtils.escapeHtml(editedUser.getFirstName()) %>"></td>
            </tr>
            <tr>
                <td class="imcmsAdmText"><? templates/sv/AdminUserResp.htm/16 ?></td>
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__LAST_NAME %>" size="25"
                           maxlength="30" value="<%= StringEscapeUtils.escapeHtml(editedUser.getLastName()) %>"></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__TITLE %>" size="25" maxlength="30"
                           value="<%= StringEscapeUtils.escapeHtml(editedUser.getTitle()) %>"></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__COMPANY %>" size="25" maxlength="30"
                           value="<%= StringEscapeUtils.escapeHtml(editedUser.getCompany())%>"></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__ADDRESS %>" size="25" maxlength="30"
                           value="<%= StringEscapeUtils.escapeHtml(editedUser.getAddress())%>"></td>
            </tr>
            <tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__ZIP %>" size="7"
                                       maxlength="30" value="<%= StringEscapeUtils.escapeHtml(editedUser.getZip())%>">
                            </td>
                            <td>&nbsp;</td>
                            <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__CITY %>" size="25"
                                       maxlength="30" value="<%= StringEscapeUtils.escapeHtml(editedUser.getCity())%>">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__DISTRICT %>" size="25" maxlength="30"
                           value="<%= StringEscapeUtils.escapeHtml(editedUser.getProvince())%>"></td>
            </tr>
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__COUNTRY %>" size="25" maxlength="30"
                           value="<%= StringEscapeUtils.escapeHtml(editedUser.getCountry())%>"></td>
            </tr>
            <tr>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__EDITED_PHONE_NUMBER %>"
                                       size="16" maxlength="25" value="<%= userEditorPage.getCurrentPhoneNumber() %>">
                            </td>
                            <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td><input type="text" name="<%= UserEditorPage.REQUEST_PARAMETER__EMAIL %>" size="50" maxlength="50"
                           value="<%= StringEscapeUtils.escapeHtml(editedUser.getEmailAddress())%>"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">&nbsp;<br>#gui_heading( "<? templates/sv/AdminUserResp_superadmin_part.htm/3/1 ?>" )
                </td>
            </tr>
            <tr valign="top">
                <td class="imcmsAdmText" nowrap>
                            ...
                            <td align="right">
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        %>
                                        <td><span class="error"><%= errorMessage.toLocalizedString(request) %></span>
                                        </td>
                                        <td>&nbsp;</td>
                                        <%
                                            }
