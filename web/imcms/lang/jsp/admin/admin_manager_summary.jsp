...
<%
    ...
    List documents_changed = adminManagerPage.getDocuments_changed();
...
#gui_outer_start()
<!--gui_head -->
#gui_head( "<? web/imcms/lang/jsp/admin/admin_manager.jsp/1 ?> - <? web/imcms/lang/jsp/admin/admin_manager.jsp/tab_name/2 ?>" )
<!-- /gui_head -->
