<%@ page import="com.imcode.imcms.servlet.admin.ImageEditPage, 
                 com.imcode.imcms.servlet.admin.EditImage,
                 com.imcode.imcms.api.I18nSupport"%><%@page contentType="text/javascript" %>
Xinha.prototype._insertImage = function(image)
{
    ...
    if ( image )
    {
        ...
        <% String suffix = "_" + I18nSupport.getCurrentLanguage().getCode(); %>
