...
%>
/*
 * imCMS version of: https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/themes/redmond/jquery-ui.css
 ...
 */
	...
	.imcmsAdmin.ui-helper-hidden-accessible { position: absolute !important; clip: rect(1px 1px 1px 1px); clip: rect(1px,1px,1px,1px); }
	...
	* html .ui-helper-clearfix { height:1%; }
	...
	/* Corner radius */
	.imcmsAdmin.ui-corner-all, .ui-corner-top, .ui-corner-left, .ui-corner-tl { -moz-border-radius-topleft: 5px; -webkit-border-top-left-radius: 5px; -khtml-border-top-left-radius: 5px; border-top-left-radius: 5px; }
	.imcmsAdmin.ui-corner-all, .ui-corner-top, .ui-corner-right, .ui-corner-tr { -moz-border-radius-topright: 5px; -webkit-border-top-right-radius: 5px; -khtml-border-top-right-radius: 5px; border-top-right-radius: 5px; }
	.imcmsAdmin.ui-corner-all, .ui-corner-bottom, .ui-corner-left, .ui-corner-bl { -moz-border-radius-bottomleft: 5px; -webkit-border-bottom-left-radius: 5px; -khtml-border-bottom-left-radius: 5px; border-bottom-left-radius: 5px; }
	.imcmsAdmin.ui-corner-all, .ui-corner-bottom, .ui-corner-right, .ui-corner-br { -moz-border-radius-bottomright: 5px; -webkit-border-bottom-right-radius: 5px; -khtml-border-bottom-right-radius: 5px; border-bottom-right-radius: 5px; }
	...
	.imcmsAdmin.ui-widget-shadow { margin: -8px 0 0 -8px; padding: 8px; background: #aaaaaa url(images/ui-bg_flat_0_aaaaaa_40x100.png) 50% 50% repeat-x; opacity: .30;filter:Alpha(Opacity=30); -moz-border-radius: 8px; -khtml-border-radius: 8px; -webkit-border-radius: 8px; border-radius: 8px; }/*
	...
	* html .ui-autocomplete { width:1px; } /* without this, the menu expands to 100% in IE6 */
	...
	.imcmsAdmin.ui-dialog .ui-dialog-titlebar { padding: .4em 1em; position: relative;  }
	.imcmsAdmin.ui-dialog .ui-dialog-title { float: left; margin: .1em 16px .1em 0; } 
	 ...
	 */
	.imcmsAdmin.ui-datepicker { width: 17em; padding: .2em .2em 0; display: none; }
	...
	.imcmsAdmin.ui-datepicker-row-break { clear:both; width:100%; font-size:0em; }
