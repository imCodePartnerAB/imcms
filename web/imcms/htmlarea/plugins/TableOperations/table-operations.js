...
TableOperations.prototype.dialogRowCellProperties = function(cell) {
	...
	function (dialog) {
		...
		var f_align  = (element.align != "") ? element.align : "" ;
		var f_valign = (element.vAlign != "") ? element.vAlign : "" ;
		...
		dialog.content.innerHTML = " \
<div class='title'\
 style='background: url(" + dialog.editor.imgURL(cell ? "cell-prop.gif" : "row-prop.gif", "TableOperations") + ") #fff 98% 50% no-repeat'>" + i18n[cell ? "Cell Properties" : "Row Properties"] + "</div> \
<table style='width:100%'> \
  <tr> \
    <td id='--HA-layout'> \
