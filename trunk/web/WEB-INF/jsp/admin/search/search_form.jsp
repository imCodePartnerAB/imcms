        ...
        <tr>
            <td valign="middle" style="padding-right:15px;">
                <a id="close_persons" href="#persons">
                    <spring:message code="admin/terms/persons" htmlEscape="true"/>
                </a>
            </td>
            <td id="fold_persons" style="${fold.personsCollapsed ? 'display:none;' : ''}">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <spring:message var="unselectedColumnTitle" code="admin/search/contains_creator" htmlEscape="true"/>
                    <spring:message var="selectedColumnTitle" code="admin/search/use" htmlEscape="true"/>
                    ...
                    <spring:message var="unselectedColumnTitle" code="admin/search/contains_publisher" htmlEscape="true"/>
                    <spring:message var="selectedColumnTitle" code="admin/search/use" htmlEscape="true"/>
                    <%@ include file="/WEB-INF/jsp/admin/includes/select_columns.jsp" %>
                </table>
            </td>
        ...
        <tr>
            <td valign="middle" style="padding-right:15px;">
                <a id="close_profile" href="#profile">
                    <spring:message code="admin/terms/profile" htmlEscape="true"/>
                </a>
            </td>
        ...
        <tr>
            <td valign="middle" style="padding-right:15px;">
                <a id="close_categories" href="#categories">
                    <spring:message code="admin/terms/categories" htmlEscape="true"/>
                </a>
            </td>
            <td id="fold_categories" style="${fold.categoriesCollapsed ? 'display:none;' : ''}">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <spring:message var="unselectedColumnTitle" code="admin/search/contains_category" htmlEscape="true"/>
                    <spring:message var="selectedColumnTitle" code="admin/search/use" htmlEscape="true"/>
                    <%@ include file="/WEB-INF/jsp/admin/includes/select_columns.jsp" %>
                </table>
            </td>
        ...
        <tr>
            <td valign="middle" style="padding-right:15px;">
                <a id="close_role" href="#role">
                    <spring:message code="admin/terms/role" htmlEscape="true"/>
                </a>
            </td>
        ...
        <tr>
            <td valign="middle" style="padding-right:15px;">
                <a id="close_status" href="#status">
                    <spring:message code="admin/terms/status" htmlEscape="true"/>
                </a>
            </td>
        ...
        <tr>
            ...
            <td>
                <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                        <td>
                            <spring:message var="clearText" code="admin/controls/clear" htmlEscape="true"/>
                        ...
                        <td align="right">
                            ...
                            <spring:message var="searchText" code="admin/controls/search" htmlEscape="true"/>
