...
public class ChatControl extends ChatBase {
    ...
    private String settingsButton( HttpServletRequest req, imcode.external.chat.Chat chat ) throws IOException {
    ...
    //
    private synchronized void createSettingsPage( HttpServletRequest req, HttpServletResponse res, HttpSession session,
