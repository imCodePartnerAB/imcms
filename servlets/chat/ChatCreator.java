...
public class ChatCreator extends ChatBase {
    ...
    private String getTemplateButtonHtml(HttpServletRequest req, String metaId) throws IOException {
        IMCServiceInterface imcref = IMCServiceRMI.getIMCServiceInterface(req);
        IMCPoolInterface chatref = IMCServiceRMI.getChatIMCPoolInterface(req);
    ...
    //peter keep
    private Vector createTaggs(HttpServletRequest req, Chat chat) throws IOException {
