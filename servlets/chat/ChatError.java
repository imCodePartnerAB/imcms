...
public class ChatError extends ChatBase
{
	...
	*/
	public ChatError() throws ServletException, IOException
	{
		myErrorHeader  = "" ;
		myErrorMessage = "" ;
	}
	...
	public ChatError(HttpServletRequest req, HttpServletResponse res, String header, String msg, int errorCode)
	throws ServletException, IOException
	{
	...
	/**
	ChatError, takes a message instead of an int
	*/
	public ChatError(HttpServletRequest req, HttpServletResponse res, String header, String msg)
	throws ServletException, IOException
	{
	...
	*/
	...
	{
		super.log("ChatError: " + msg) ;
		// System.out.println("ChatError: " + msg) ;
	}
