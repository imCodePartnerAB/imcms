...
public class Conference extends HttpServlet {
    ...
    **/
	...
	if(lastLoginDate == null) {
	    ...
	    firstName = (String) confref.sqlProcedureStr( sqlName ) ;
	    sqlName = "A_GetConfLoginNames " + metaId +", "+ loginUserId +", "+  2 ;
	    lastName = (String) confref.sqlProcedureStr( sqlName ) ;
	} // end else
	...
	if (session != null) {
	    ...
	    String aForumId = confref.sqlProcedureStr("A_GetFirstForum " + params.getProperty("META_ID")) ;
    ...
    **/
    ...
    public String getAdminButtonLink(HttpServletRequest req,imcode.server.user.UserDomainObject user, VariableManager adminButtonVM )
	throws ServletException, IOException {
    ...
    /**
       ...
       to the adminservlet.
    */
    public String getUnAdminButtonLink(HttpServletRequest req,imcode.server.user.UserDomainObject user, VariableManager unAdminButtonVM )
	throws ServletException, IOException {
