...
public class ConfReply extends Conference {
    ...
    public void doGet( HttpServletRequest req, HttpServletResponse res ) throws ServletException, IOException {
        ...
        String sqlAnswer[] = confref.sqlProcedureExt( sqlQ );


        // Lets get the discussion header
        String discHeader = confref.sqlProcedureStr( "A_GetDiscussionHeader " + discId );
        ...
        String sortOrderValue = confref.sqlProcedureStr( sql );
        String ascState = "";
        String descState = "";
        String ascVal = "0";
        ...
        String sqlTimeStr = confref.sqlProcedureStr( "A_GetTime" );
        ...
        try {
            ...
            for ( int i = nbrOfCols + 1; i < DBArr.length; i += nbrOfCols ) {
                ...
                for ( int j = i; j < i + nbrOfCols; j++ ) {
                    ...
                    String s = this.replaceLinefeedWithString( b, "<BR>" ).toString();
                ...
                dataV = this.getReplyLevelCode( dataV, imagePath );
     ...
     **/
    public static StringBuffer replaceLinefeedWithString( StringBuffer strBuff, String replacement ) {
     ...
     */
    protected static Vector getReplyLevelCode( Vector dataV, String ImagePath ) {
