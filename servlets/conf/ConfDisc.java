...
public class ConfDisc extends Conference {
    ...
    private String A_HREF_HTML;   // The code snippet where the aHref list with all discussions
...
// Lets bee ready to create button and new flags
     ...
     */
    private String preParse( HttpServletRequest req, String[][] DBArr, Vector tagsV,
