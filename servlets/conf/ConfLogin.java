...
public class ConfLogin extends Conference {
    ...
    public void doGet( HttpServletRequest req, HttpServletResponse res )
        ...
        if ( loginType.equalsIgnoreCase( "ADMIN_USER" ) ) {
            ...
            if ( super.getAdminRights( imcref, "" + params.getMetaId(), user ) == false ) {
            ...
            String[] usersArr = confref.sqlQuery( "A_GetAllConfUsersInList " + params.getMetaId() );
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res )
        ...
        if ( loginType.equalsIgnoreCase( "login" ) /* && req.getParameter("submit") != null */ ) {
            ...
            String checkUserSql = "A_MemberInConf " + params.getMetaId() + ", " + userId;
        ...
        if ( loginType.equalsIgnoreCase( "ADD_USER" ) ) {
            ...
            String sqlSproc = "A_SelfRegRoles_GetAll2 " + params.getMetaId();
        ...
        if ( req.getParameter( "CHANGE_USER" ) != null ) {
            ...
            String level = confref.sqlProcedureStr( "A_ConfUsersGetUserLevel " + params.getMetaId() + ", " + userId );
            String levelStatus = "";
        ...
        if ( req.getParameter( "SAVE_USER" ) != null ) {
            ...
            String sqlQ = "A_ConfUsersSetUserLevel " + params.getMetaId() + ", ";
