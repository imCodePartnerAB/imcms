...
public class Administrator extends HttpServlet {
    ...
    static imcode.server.User getUserObj(HttpServletRequest req,
    ...
    static boolean checkSession(HttpServletRequest req, HttpServletResponse res)
            throws IOException {
    ...
    static boolean checkAdminRights(HttpServletRequest req, HttpServletResponse res)
            throws IOException {
     ...
     */
    File getAdminTemplateFolder(IMCServiceInterface imcref, imcode.server.User user) {
    ...
    String createHtml(HttpServletRequest req, HttpServletResponse res,
