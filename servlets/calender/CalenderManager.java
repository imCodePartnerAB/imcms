...
public class CalenderManager extends Calender
{
    ...
    */
	...
	if (action.equalsIgnoreCase("NEW")) {
	    ...
	    String imagePath = imcref.getImageUrl() + user.getLangPrefix() + "/107";
	    ...
	    String select = playersSelectBox(req, prop);
	    ...
	    variables.add("#SIZE#");
	    variables.add( playersSelectBoxSize(req,prop) );
    ...
    */
    ...
    /**
       ...
       @throws IOException if detected when handling the request
    */
    private String playersSelectBox(HttpServletRequest req, Properties prop) throws IOException{
    ...
    /**
       ...
       @throws IOException if detected when handling the request
    */
    private String playersSelectBoxSize(HttpServletRequest req, Properties prop) throws IOException{
