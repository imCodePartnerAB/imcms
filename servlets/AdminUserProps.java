...
public class AdminUserProps extends Administrator {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (req.getParameter("ADD_USER") != null) {
            ...
            // phonetype list
            String phonetypes = Html.createHtmlCode("ID_OPTION", "1", phoneTypesV);
            vec.add("#PHONETYPES_MENU#");
            vec.add(phonetypes);
		
            // phoneslist
            String phones = Html.createHtmlCode("ID_OPTION", "", tmp_phones);
            vec.add("#PHONES_MENU#");
            vec.add(phones);
            ...
            String[] langList = imcref.sqlProcedure("GetLanguageList", new String[]{user.getLangPrefix()});
            Vector selectedLangV = new Vector();
            selectedLangV.add("1");
            vec.add("#LANG_TYPES#");
            vec.add(Html.createHtmlCode("ID_OPTION", selectedLangV, new Vector(java.util.Arrays.asList(langList))));
...
//			userType= tmp_userType;
            ...
            String phones = Html.createHtmlCode("ID_OPTION", selected, phonesV);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (req.getParameter("ok_phones") != null || req.getParameter("delete_phones") != null || req.getParameter("edit_phones") != null) {
            ...
            // phonetype list
            String phonetypes = Html.createHtmlCode("ID_OPTION", phonetypes_id, phoneTypesV);
...
//		log("selected_id= "+ selectedPhoneId);
            ...
            // add phones list
            String phones = Html.createHtmlCode("ID_OPTION", selectedPhoneId, phonesV);
...
*/
        ...
        if (req.getParameter("SAVE_USER") != null && adminTask.equalsIgnoreCase("ADD_USER")) {
            ...
            */	
            ...
            imcref.sqlUpdateProcedure("AddNewUser", UserHandler.createUserInfoSprocParameterArray(params));
            ...
            if (null == req.getParameter("userTemplate")) {
                ...
                if (!("").equals(workPhone)) {
                    imcref.sqlUpdateProcedure("PhoneNbrAdd", new String[]{newUserId, workPhone, "2"});
                }
                if (!("").equals(mobilePhone)) {
                    imcref.sqlUpdateProcedure("PhoneNbrAdd", new String[]{newUserId, workPhone, "3"});
                }
            }
        ...
        if (req.getParameter("SAVE_USER") != null && adminTask.equalsIgnoreCase("SAVE_CHANGED_USER")) {
            ...
            */	
            ...
            // Lets build the users information into a string and add it to db
            imcref.sqlUpdateProcedure("UpdateUser", UserHandler.createUserInfoSprocParameterArray(params));
    ...
    private String getNewUserID(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        String host = req.getHeader("Host");
        IMCServiceInterface imcref = IMCServiceRMI.getIMCServiceInterfaceByHost(host);
        ...
        if (newUserId.equals("")) {
            ...
            new AdminError(req, res, aHeader, msg);
            return null;
        }
        return newUserId;
    ...
    private Properties getParameters(HttpServletRequest req, IMCServiceInterface imcref, User user, User userToChange) {
    ...
    private String createAdminPartHtml(User user, User userToChange, IMCServiceInterface imcref, HttpServletRequest req, HttpServletResponse res, HttpSession session) {
        ...
        if (userToChange == null) {   // ADD_USER mode 
            ...
            String user_type = Html.createHtmlCode("ID_OPTION", userType, userTypesV);
