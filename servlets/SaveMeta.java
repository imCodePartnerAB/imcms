...
public class SaveMeta extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        */
        ...
        if (req.getParameter("define_set_1") != null) {	// If user want's to edit permission-set 1
            ...
            out.write(
                    MetaDataParser.parseMetaPermission(meta_id, meta_id, user, host,
                                                       "change_meta_rights.html"));
            return;
        }
        ...
        if (null != req.getParameter("activated_date")) {
            sqlStr += "activated_datetime = "
                      + (null == activated_datetime ? "NULL" : "'" + activated_datetime + "'")
                      + ",";
        }
        if (null != req.getParameter("archived_date")) {
            sqlStr += "archived_datetime = "
        ...
        for (int i = 0; i < role_permissions.length; ++i) {
            ...
            imcref.sqlUpdateProcedure(
                    "SetRoleDocPermissionSetId " + role_id + "," + meta_id + "," + new_set_id);
        }
        ...
        imcref.sqlUpdateProcedure(
                "UpdateDefaultTemplates '" + meta_id + "','" + template1 + "','" + template2 + "'");
        ...
        if (created_datetime != null) {
            ...
            sqlStr = "update meta set date_created ='" + created_datetime + "' where meta_id = "
                     + meta_id;
            imcref.sqlUpdateQuery(sqlStr);
        }
        if (modified_datetime != null) {
            //we did got a ok date so lets save it to db
            sqlStr = "update meta set date_modified ='" + modified_datetime + "' where meta_id = "
                     + meta_id;
            imcref.sqlUpdateQuery(sqlStr);
        }
        ...
        setSessionInDbFromRequest(req, imcref, meta_id);
    ...
    static void setSessionInDbFromRequest(HttpServletRequest req, IMCServiceInterface imcref,
                                          String metaId) {
