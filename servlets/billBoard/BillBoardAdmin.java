...
public class BillBoardAdmin extends BillBoard {//ConfAdmin
     ...
     */
    private String replyPreParse(HttpServletRequest req, String[][] DBArr, Vector tagsV,
                                File htmlCodeFile) {

        return discPreParse(req, DBArr, tagsV, htmlCodeFile);
    }
     ...
     */
    //(HttpServletRequest req, String[] DBArr, Vector tagsV,String htmlCodeFile)
    private String discPreParse(HttpServletRequest req, String[][] DBArr, Vector tagsV,
                               File htmlCodeFile) {
