...
public class AdminQuestionsFile extends Administrator implements imcode.server.IMCConstants {
    ...
    */
    ...
    private StringBuffer createOptionList(HttpServletRequest req, List lines, IMCServiceInterface imcref, imcode.server.user.UserDomainObject user ) throws ServletException, IOException {
