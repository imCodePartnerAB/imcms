...
public class GetExistingDoc extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if ((req.getParameter("cancel") != null) || (req.getParameter("cancel.x") != null)) {
            ...
            String[] sortOrder = imcref.sqlProcedure("SortOrder_GetExistingDocs", new String[] {langPrefix});
            ...
            String sortOrderStr = Html.createHtmlCode("ID_OPTION", sortBy, sortOrderV);
