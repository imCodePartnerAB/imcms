...
public class ImageBrowse extends HttpServlet {
    ...
    public static String getPage( HttpServletRequest req ) throws IOException {
        ...
        if ( img_dir_preset == null ) {//if img_dir_preset null then its first time, or a prew. of choosen image
     ...
     */
    private static File getAdminTemplateFolder( IMCServiceInterface imcref, imcode.server.User user ) {
