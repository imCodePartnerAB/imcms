            ...
            while (enum.hasMoreElements()) {
                ...
                if (param.indexOf("bid") == 0) {
                    ...
                    try {
                        ...
                        imcref.sqlUpdateQuery("update browser_docs set to_meta_id = " + t + " where meta_id = " + meta_id + " and browser_id = " + bid, new String[]{"" + t, "" + meta_id, bid});
                    } catch (NumberFormatException ex) {
                        if (!bid.equals("0")) {
                            imcref.sqlUpdateQuery("delete from browser_docs where meta_id = " + meta_id + " and browser_id = " + bid, new String[]{"" + meta_id, bid});
                        }
                    }
                }
            }
