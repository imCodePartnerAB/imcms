...
public class SaveNewBrowserDoc extends HttpServlet {
    ...
    public void doPost( HttpServletRequest req, HttpServletResponse res ) throws ServletException, IOException {
        ...
        if ( req.getParameter( "cancel" ) != null ) {
            ...
            while ( enum.hasMoreElements() ) {
                ...
                if ( param.indexOf( "bid" ) == 0 ) {
                    ...
                    try {
                        ...
                        // FIXME: Move to SProc
                        sqlStr =
                        "update browser_docs set to_meta_id = " + t + " where meta_id = " + meta_id + " and browser_id = " + bid;
            ...
            // FIXME: Move to SProc
            sqlStr =
            "select browser_id,name from browsers where browser_id not in (select browsers.browser_id from browser_docs join browsers on browsers.browser_id = browser_docs.browser_id where meta_id = " + meta_id + " ) order by value desc,name asc";
