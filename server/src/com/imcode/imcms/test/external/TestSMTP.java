...
public class TestSMTP extends TestCase {
    ...
    private static final String TEST_MAIL = "Testing swedish characters: ���\n" 
    ...
    public void testHtml() throws IOException {
        ...
        mail.setHtmlBody("<html><body>This mail should have an <strong>HTML</strong> <em>alternative</em> and these swedish characters should be OK: ���.</body></html>");
        smtp.sendMail( mail );
    }
}
