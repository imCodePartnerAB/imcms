...
public class ConfAdd extends Conference {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        if (user.canEdit( document )) {
            ...
            if (addType.equalsIgnoreCase("DISCUSSION") && (req.getParameter("ADD") != null || req.getParameter("ADD.x") != null)) {
                ...
                String level = imcref.getDatabase().executeStringProcedure( "A_ConfUsersGetUserLevel", new String[] {params.getProperty( "META_ID" ),
                                                                                                               userId} );
                ...
                imcref.getDatabase().executeUpdateProcedure( "A_AddNewDisc", new String[] {aForumId,
                                                                                                userId, addHeader,
                                                                                                addText, level} );
                ...
                if (session != null) {
                    String latestDiscId = imcref.getDatabase().executeStringProcedure( "A_GetLastDiscussionId", new String[] {params.getProperty( "META_ID" ),
                                                                                                                          aForumId} );
            ...
            if (addType.equalsIgnoreCase("REPLY") && (req.getParameter("ADD") != null || req.getParameter("ADD.x") != null)) {
                ...
                imcref.getDatabase().executeUpdateProcedure( "A_AddReply", new String[] {userId,
                                                                                                discId, addHeader,
                                                                                                addText, level} );
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (user.canEdit( document )) {
            ...
            String firstName = imcref.getDatabase().executeStringProcedure( "A_GetConfLoginNames", new String[] {params.getProperty( "META_ID" ),
                                                                                                               loginUserId,
                                                                                                               "1"} );
            String lastName = imcref.getDatabase().executeStringProcedure( "A_GetConfLoginNames", new String[] {params.getProperty( "META_ID" ),
                                                                                                              loginUserId,
                                                                                                              "2"} );
            ...
            String currForum = imcref.getDatabase().executeStringProcedure( "A_GetForumName", new String[] {params.getProperty( "FORUM_ID" )} );
            ...
            if (params.getProperty("ADD_TYPE").equalsIgnoreCase("REPLY")) {
                ...
                String[] arr = imcref.getDatabase().executeArrayProcedure( "A_GetDiscussionHeader", new String[] {aDiscId} );
                if (arr != null) {
                    if (arr.length > 0) {
                        discHeader = arr[0];
                    }
