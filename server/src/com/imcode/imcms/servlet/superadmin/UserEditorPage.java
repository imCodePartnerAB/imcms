...
import static com.imcode.imcms.domain.services.core.TwoFactorAuthService.USER_2FA_DISABLED_PROPERTY;
...
public class UserEditorPage extends OkCancelPage {
    ...
    private static final int MAXIMUM_PASSWORD_LENGTH = 250;
