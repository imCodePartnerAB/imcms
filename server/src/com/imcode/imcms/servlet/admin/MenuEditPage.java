    ...
    protected void dispatchOther(HttpServletRequest request,
        ...
        if (null != request.getParameter(CREATE)) {
            ...
            if (0 == documentTypeId) {
                ...
                DocumentCreator documentCreator = new DocumentCreator(new SaveNewDocumentAndAddToMenuCommand(textDocument, menuIndex), (DispatchCommand) this::forward, servletContext);
                try {
