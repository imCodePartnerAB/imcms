...
//        boolean userHasRights = DocumentMapper.checkUsersRights( imcref, user, req.getParameter("meta_id"), user.getLanguageIso639_2(), doc_type );
//
...
//            createExistingDocPage( sessionData, imcref, user, user.getLanguageIso639_2(), out );
//            return;
//
