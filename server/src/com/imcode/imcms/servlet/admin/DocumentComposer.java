...
public class DocumentComposer extends HttpServlet {
    ...
    public void doPost( HttpServletRequest r, HttpServletResponse response ) throws ServletException, IOException {
        ...
        if ( ACTION__CREATE_NEW_DOCUMENT.equalsIgnoreCase( action ) ) {
            forwardToDocinfoPageWithCloneOfParent( newDocumentParentInformation, request, response, user );
            ...
            UrlDocumentDomainObject newUrlDocument = (UrlDocumentDomainObject)getObjectFromSessionWithKeyInRequest( request, REQUEST_ATTR_OR_PARAM__DOCUMENT_SESSION_ATTRIBUTE_NAME );
            ...
            HtmlDocumentDomainObject newHtmlDocument = (HtmlDocumentDomainObject)getObjectFromSessionWithKeyInRequest( request, REQUEST_ATTR_OR_PARAM__DOCUMENT_SESSION_ATTRIBUTE_NAME );
            ...
            FileDocumentDomainObject newFileDocument = (FileDocumentDomainObject)getObjectFromSessionWithKeyInRequest( request, REQUEST_ATTR_OR_PARAM__DOCUMENT_SESSION_ATTRIBUTE_NAME );
    ...
    public void saveNewDocumentAndAddToMenuAndRemoveSessionAttributesAndRedirectToParent(
    ...
    private static String getSessionAttributeNameFromRequest( HttpServletRequest request,
                                                              String requestAttributeOrParameterName ) {
    ...
    private void forwardToDocinfoPageWithCloneOfParent( final NewDocumentParentInformation newDocumentParameters, HttpServletRequest request,
                                                        HttpServletResponse response, UserDomainObject user ) throws ServletException, IOException {
        final IMCServiceInterface service = ApplicationServer.getIMCServiceInterface();
        final DocumentMapper documentMapper = service.getDocumentMapper();
        DocumentDomainObject newDocument = null;
        try {
            newDocument = (DocumentDomainObject)documentMapper.getDocument( newDocumentParameters.parentId ).clone();
