...
public class ChatBase extends HttpServlet implements ChatConstants {
    ...
    private Logger log = Logger.getLogger( "imcode.external.chat.ChatBase" );
    ...
    //peter keep
    protected Chat createChat( HttpServletRequest req, imcode.server.User user, int metaId ) throws IOException {
     ...
     */
    protected String getMetaId( HttpServletRequest req ) {
    ...
    protected File getExternalTemplateFolder( HttpServletRequest req ) throws IOException {
        ...
        // Lets get serverinformation
        return new File( imcref.getExternalTemplateFolder( Integer.parseInt( metaId ) ), getTemplateLibName( chatref, metaId ) );
    }
     ...
     */
    //peter uses this
    protected static String getTemplateLibName( IMCPoolInterface chatref, String meta_id ) {
    ...
    protected void sendHtml( HttpServletRequest req, HttpServletResponse res,
        ...
        final String htmlStr = imcref.parseExternalDoc( vect, template, imcref.getLanguage(), "103", templateSet );
        out.print( htmlStr );
        out.flush();
        out.close();
    }
