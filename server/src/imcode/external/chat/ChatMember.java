...
public class ChatMember {
    ...
    protected ChatMember( int memberId, Chat parent, User user ) {
        _msgBuffer = Collections.synchronizedList( new LinkedList() );
        this.memberId = memberId;
        this.user = user;
        //_myChatSettings = settings;
        _parent = parent;
    }
    ...
    public void addMessageHistory() {
        ...
        synchronized ( _msgBuffer ) {
            ...
            cal.set(Calendar.HOUR, cal.get(Calendar.HOUR) - HOURS__BACK_FOR__HISTORY );
            cal.set(Calendar.MINUTE, cal.get(Calendar.MINUTE) - MINUTE__BACK_FOR__HISTORY );
    ...
    public boolean equals( Object o ) {
        ...
        if ( memberId != chatMember.memberId ) return false;
