...
public class ChatMember {
	...
	private Hashtable _myChatSettings = new Hashtable();
	private int _userId;
	...
	*/
	...
	protected ChatMember(int memberNumber,Chat parent){
	...
	*/
	...
	public boolean addNewChatMsg(ChatMsg msg){
	...
	*/
	...
	public Hashtable getProperties(){
		return (Hashtable)_myChatSettings;
	}

	public void setProperties(Hashtable settings){
		_myChatSettings = settings;
	}
