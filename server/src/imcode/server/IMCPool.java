...
public class IMCPool extends UnicastRemoteObject implements IMCPoolInterface {
	...
	javax.swing.JTextArea m_output ;      // output area
	...
	*/
	...
	public IMCPool(imcode.server.InetPoolManager conPool,javax.swing.JTextArea output,String serverName)
	...
	throws java.rmi.RemoteException {
     ...
     try {
      imcode.server.Preference prefs = new imcode.server.Preference() ;
			prefs.loadConfig("ImcServer.cfg",serverName) ;



			prefs = null ; 
			} catch(Exception ex) {
         m_output.append("Exception : Reading property file.") ;
			ex.printStackTrace() ;
			}	
	...
	public IMCPool() throws java.rmi.RemoteException {
		super() ;
	}
