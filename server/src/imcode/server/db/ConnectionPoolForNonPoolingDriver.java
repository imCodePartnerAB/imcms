...
public class ConnectionPoolForNonPoolingDriver implements ConnectionPool {
    ...
    private static class Logger {
        private static Category log = Category.getInstance( "ConnectionPoolForNonPoolingDriver" );
...
//        s_logDatabaseData( getConnection() );
    ...
    private static void s_testFullPoolAndReturningOfConnectionWhenClose( String driverClassName, String dbUrl ) throws Exception {
        int poolSize = 1;
        ConnectionPoolForNonPoolingDriver cm = new ConnectionPoolForNonPoolingDriver( "InternalServerName", driverClassName, dbUrl, "sa", "sa", poolSize );
    ...
    private static void s_testTwoDifferentConnections( String driverClassName, String dbUrl ) throws Exception {
        ConnectionPoolForNonPoolingDriver cm = new ConnectionPoolForNonPoolingDriver( "InternalServerName", driverClassName, dbUrl, "sa", "sa", 20 );
    ...
    private static void s_testConnectionWithPool( String driverClassName, String dbUrl ) throws Exception {
        ConnectionPoolForNonPoolingDriver cm = new ConnectionPoolForNonPoolingDriver( "InternalServerName", driverClassName, dbUrl, "sa", "sa", 20 );
        cm.testConnectionAndLoggResultToTheErrorLog();
    }
    ...
    private static DatabaseMetaData s_getConnectionMetaData( String driverClassName, String dbUrl ) throws Exception {
        ConnectionPoolForNonPoolingDriver cm = new ConnectionPoolForNonPoolingDriver( "InterntServerNamn", driverClassName, dbUrl, "sa", "sa", 20 );
