...
public class TextDocumentParser implements imcode.server.IMCConstants {
    ...
    public TextDocumentParser( IMCServiceInterface serverobject, InetPoolManager connpool,
    ...
    */
    ...
    public String parsePage( DocumentRequest documentRequest, int flags, int includelevel,
        ...
        try {
            ...
            dbc.setProcedure( "GetUserPermissionSet (?,?)", metaIdUserIdPair );
            Vector user_permission_set = dbc.executeProcedure();
            ...
            if (menumode) {
                ...
                doc_types_vec = dbc.executeProcedure();
            }
            ...
            if (templatemode) {
                ...
                dbc.setProcedure( sqlStr, sqlAry2 );
                templategroups = dbc.executeProcedure();
            ...
            sqlStr = "getChilds (?,?)";
            dbc.setProcedure( sqlStr, metaIdUserIdPair );
            ...
            Vector section_data = dbc.executeProcedure();
    ...
    class MenuItemHeadlineComparator implements Comparator {
        ...
        MenuItemHeadlineComparator( String lang ) {
            Locale locale;
    ...
    class MenuItemManualSortOrderComparator implements Comparator {
        public int compare( Object o1, Object o2 ) {
