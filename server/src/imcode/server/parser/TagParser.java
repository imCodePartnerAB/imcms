...
public class TagParser {
    ...
    private final static Logger LOG = LogManager.getLogger(TagParser.class.getName());
    ...
    public String tagImage(Properties attributes, boolean imageMode, int[] implicitImageIndex,
        ...
        if (imageMode && (textDocumentToUse.getId() == document.getId())) {
            ...
            List<String> replaceTags = new ArrayList<>(replace_tags.length + 8);
            ...
            replaceTags.add("#is_linkable#");
            replaceTags.add(linkable);
