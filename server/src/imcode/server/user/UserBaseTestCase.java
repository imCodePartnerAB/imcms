...
abstract class UserBaseTestCase extends TestCase {
   ...
   static final String[] SQL_RESULT_ADMIN = {"1", "admin", "admin", "Admin", "Super", "", "", "", "", "", "", "", "", "1", DEFAULT_LANGUAGE, "1", "2003-05-12 00:00:00", "0"};
   final static String[] SQL_RESULT_USER = {"2", "user", "user", "User", "Extern", "", "", "", "", "", "", "", "", "1", DEFAULT_LANGUAGE, "1", "2003-05-12 00:00:00", "0"};
   static final String[] SQL_RESULT_HASBRA = {"3", "hasbra", "hasbra", "Hasse", "Brattberg", "", "", "", "", "", "", "", "", "1", DEFAULT_LANGUAGE, "1", "2003-05-12 00:00:00", "1"};
