...
class MultipartParser {
    ...
    private Hashtable[] headparams;	//Contains a Hashtable of Properties to keep track of the fileItemMap for each individual header.
    ...
    /**
     * Gets the fileItemMap of a single MIME-header from a part.
     *
     * @param part The part to get the header from.
     * @param name The name of the header.
     * @return A propertylist containing the fileItemMap of the header.
     */
