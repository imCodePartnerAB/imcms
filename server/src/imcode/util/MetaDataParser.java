...
public class MetaDataParser {
     ...
     */
    static public String parseMetaData( String meta_id, String parent_meta_id, UserDomainObject user, String host )
            throws IOException {
     ...
     */
    static public void getRolesFromDb( String meta_id, UserDomainObject user, String host, Vector vec )
            throws IOException {
        ...
        if ( user_set_id < 2 ) {
            ...
            if ( user_set_id == IMCConstants.DOC_PERM_SET_FULL ) {
                ...
                if ( doc_type == DocumentDomainObject.DOCTYPE_TEXT ) {
                    ...
                    default_templates =
                    getDefaultTemplateOptionList( imcref, user, temp_default_templates, meta_id, lang_prefix, true );
                ...
                if ( doc_type == DocumentDomainObject.DOCTYPE_TEXT ) {
                    default_templates =
                    getDefaultTemplateOptionList( imcref, user, temp_default_templates, meta_id, lang_prefix, false );
    ...
    private static synchronized String getDefaultTemplateOptionList( IMCServiceInterface imcref,
            imcode.server.user.UserDomainObject user, String[] def_templates, String meta_id, String lang_prefix,
            boolean restr_1 ) throws IOException {
        String returnValue = "";
        //ok lets setup the default_template-option-lists for restricted 1 & 2
    ...
    public static String parsePermissionSet( int meta_id, UserDomainObject user, String host, int set_id,
