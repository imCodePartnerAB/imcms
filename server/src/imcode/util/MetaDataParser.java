...
public class MetaDataParser {
     ...
     */
    private static String getMetaDataFromDb(String meta_id, String parent_meta_id, User user, String host,
     ...
     */
    private static void getRolesFromDb(String meta_id, User user, String host, Vector vec)
            throws IOException {
        ...
        if (user_set_id < 2) {
            ...
            if (user_set_id == IMCConstants.DOC_PERM_SET_FULL) {
                ...
                if (doc_type == IMCConstants.DOCTYPE_TEXT) {
                    ...
                    default_templates = getDefaultTemplateOptionList(imcref,
    ...
    public static String parsePermissionSet(int meta_id, User user, String host, int set_id,
        ...
        String[] permissionset = imcref.sqlProcedure(
                "Get" + newstr + "PermissionSet", new String[] { ""+meta_id, ""+set_id,lang_prefix } );
