 ...
 */
select  to_meta_id, menus.menu_index, menus.sort_order, manual_sort_order, tree_sort_index, doc_type,
...
group by to_meta_id, menus.menu_index, menus.sort_order, manual_sort_order, tree_sort_index, doc_type,
