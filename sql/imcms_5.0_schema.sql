...
--
-- Table i18n_available_languages
--
...
CREATE TABLE i18n_languages (
  ...
  PRIMARY KEY  (language_id),
  CONSTRAINT i18n_languages_ibfk_1 FOREIGN KEY (language_id) REFERENCES i18n_available_languages (language_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE i18n_meta (
  ...
  UNIQUE KEY uix__i18n_meta_part__language_id__meta_id (language_id,meta_id),
...
--
-- View i18n_languages_v
--

CREATE VIEW i18n_languages_v AS
  SELECT
    il.language_id,
  ...
  FROM
    i18n_languages il
  INNER JOIN
    i18n_available_languages al
  ON
    il.language_id = al.language_id;