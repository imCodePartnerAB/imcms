...
EXEC('UPDATE images SET format = 0, crop_x1 = -1, crop_y1 = -1, crop_x2 = -1, crop_y2 = -1');
EXEC('UPDATE images_history SET format = 0, crop_x1 = -1, crop_y1 = -1, crop_x2 = -1, crop_y2 = -1');
