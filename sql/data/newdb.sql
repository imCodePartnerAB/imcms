...
INSERT INTO users
 VALUES (1,'admin', 'admin', 'Admin', 'Super','','','','','','','','@servermaster-email@',0,1,convert(char(10),getDate(),120),'<? sql/default_lang ?>')
INSERT INTO users VALUES (2,'user', 'user', 'User', 'Extern','','','','','','','','',0,1,convert(char(10),getDate(),120),'<? sql/default_lang ?>')
GO
