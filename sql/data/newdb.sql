...
INSERT INTO users 
 VALUES (1,'admin', 'admin', 'Admin', 'Super','','','','','','','','',1,1001,0,1,1,1,convert(char(10),getDate(),120))
INSERT INTO users VALUES (2,'user', 'user', 'User', 'Extern','','','','','','','','',1,1001,0,1,1,1,convert(char(10),getDate(),120))
INSERT INTO roles 
