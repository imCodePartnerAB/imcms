...
VALUES
  ...
  (@start_document__meta_id+1, 2, @user_id__admin, 0, 1, 1, @'ui__language', NOW(), NOW(), 0, '_self', 1, NULL, NULL, 2, NOW(), NULL, 'DO_NOT_SHOW'),
  (@start_document__meta_id+2, 2, @user_id__admin, 0, 1, 1, @'ui__language', NOW(), NOW(), 0, '_self', 1, NULL, NULL, 2, NOW(), NULL, 'DO_NOT_SHOW');
