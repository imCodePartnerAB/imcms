...
//	private static Pattern maxHeightPattern;
    ...
    private static String removeHtmlTagsAndUrlEncode(String label) throws UnsupportedEncodingException {
        return URLEncoder.encode(Html.removeTags(label), "UTF-8");
    }
    ...
    public static String addPreAndPost(Properties attributes, String tagResult) {
        ...
        final String preAttribute = StringUtils.defaultString(attributes.getProperty("pre"));
        final String postAttribute = StringUtils.defaultString(attributes.getProperty("post"));
    ...
    public String tagInclude(Properties attributes) {
        ...
        if (null
                != (attributevalue = attributes.getProperty("no")))
        {        // If we have the attribute no="number"...
    ...
    private String includeUrl(String attribute, Properties attributes) {
        ...
        try {
            ...
            Set<String> parameterNamesToSend = createSetFromCommaSeparatedString(commaSeparatedNamesOfParametersToSend);
    ...
    private String createQueryStringFromRequest(HttpServletRequest httpServletRequest, Set<String> parameterNamesToSend) {
        List<String> parameterNameValuePairs = new ArrayList<>();
            ...
            if (null == parameterNamesToSend || parameterNamesToSend.contains(parameterName)) {
                ...
                try {
                    for (String parameterValue : parameterValues) {
                        parameterNameValuePairs.add(URLEncoder.encode(parameterName, "UTF-8") + '='
    ...
    private Set<String> createSetFromCommaSeparatedString(String commaSeparatedNames) {
    ...
    public String replaceTags(String template, boolean insideText) {
        ...
        while (patMat.contains(input, imcmsTagPattern)) {
            ...
            if ("menu".equals(tagName) || "velocity".equals(tagName)) {
                ...
                tagResult = singleTag(tagName, attributes, entireTag, insideText);
            }
