...
public class TagParser {
    ...
    public String tagText(Properties attributes, ContentLoop loop, Content content) {
        ...
        if ( null == noStr ) {
            ...
            text = content == null
                    ...
                    : textDocumentToUse.getText(no, new ContentLoopIdentity(loop.getNo(), content.getNo()));
        } else {
            noStr = noStr.trim();
    ...
    public String tagImage(Properties attributes, boolean imageMode, int[] implicitImageIndex,
        ...
        ImageDomainObject image = loop == null
                ...
                : textDocumentToUse.getImage(imageIndex, new ContentLoopIdentity(loop.getNo(), content.getNo()));
