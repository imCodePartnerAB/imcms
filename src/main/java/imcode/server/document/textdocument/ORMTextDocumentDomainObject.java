...
import imcode.server.document.ORMDocumentDomainObject;
...
/**
 * ??? Facade, not direct ???
 * ??? Direct -> only one language 
 */
public class ORMTextDocumentDomainObject extends ORMDocumentDomainObject {
    ...
    public ORMTextDocumentDomainObject() {
        this(ID_NEW) ;
    }

    public ORMTextDocumentDomainObject(int documentId) {
        setId(documentId);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        ORMTextDocumentDomainObject clone = (ORMTextDocumentDomainObject)super.clone();
