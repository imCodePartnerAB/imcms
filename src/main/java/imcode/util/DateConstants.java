...
public class DateConstants {
    ...
    public final static String SOLR_DATE_FORMAT_STRING = "yyyy-MM-dd'T'HH:mm:ss'Z'";
    ...
    public static final ThreadLocal<DateFormat> SOLR_DATE_FORMAT =
            ThreadLocal.withInitial(() -> new SimpleDateFormat(SOLR_DATE_FORMAT_STRING));
