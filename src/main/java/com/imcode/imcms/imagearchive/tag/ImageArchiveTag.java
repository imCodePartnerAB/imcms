package com.imcode.imcms.imagearchive.tag;
...
public class ImageArchiveTag extends BodyTagSupport {
    ...
    public static String getProperty(String propName) {
        return getProperties().getProperty(propName).trim();
    }
    ...
    private static Properties getProperties() {
        if (properties == null) {
            try {
                ...
                File file = new File(Imcms.getPath() + "/WEB-INF/conf", CONFIG_FILE_NAME);
...
//			String archiveUri = getContextPath() + "/archive";
            ...
            * */
            ...
            String currentLocale = Imcms.getUser().getDocGetterCallback().getLanguage().getCode();
