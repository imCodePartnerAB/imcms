...
public class IBatisPatchedScriptRunner {
    ...
    private static final String DELIMITER_CHANGE_COMMAND = "delimiter";
    ...
    public IBatisPatchedScriptRunner(Connection connection) {
    ...
    private StringBuilder handleLine(StringBuilder command, String line) throws SQLException {
        ...
        if (lineIsComment(trimmedLine)) {
            println(trimmedLine);
        } else if (lineIsDelimiterChangeLine(trimmedLine)) {
            println(trimmedLine);
            setDelimiter(trimmedLine.substring(DELIMITER_CHANGE_COMMAND.length()).trim());
    ...
    private boolean lineIsDelimiterChangeLine(String trimmedLine) {
        return trimmedLine.toLowerCase().startsWith(DELIMITER_CHANGE_COMMAND);
    }
