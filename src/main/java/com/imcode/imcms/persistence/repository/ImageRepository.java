...
public interface ImageRepository extends JpaRepository<Image, Integer> {
    ...
    Image findByVersionAndLanguageAndIndexAndLoopEntryRef(Version version, LanguageJPA language, int index, LoopEntryRef loopEntryRef);
    ...
    Integer findIdByVersionAndLanguageAndIndexAndLoopEntryRef(Version version, LanguageJPA language, int index, LoopEntryRef loopEntryRef);
