    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
        ...
        if (permissionSet.getEditTexts() && req.getParameter("cancel") == null) {
            ...
            TextDomainObject text = contentRef == null
                    ...
                    : document.getText(txt_no, contentRef);

            text = text == null ? new TextDomainObject() : text.clone();

            text.setNo(txt_no);
            text.setDocRef(document.getRef());
            text.setLanguage(Imcms.getUser().getDocGetterCallback().documentLanguages().preferred());
            ...
            if (null != req.getParameter("save")) {
                ...
                if (contentRef != null) {
                    url += "&loop_no=" + loopNo + "&content_index=" + contentNo;
                }
