...
//                fallthrough due to IMCMS-94: no more 'create doc' feature in old admin menu
            ...
            case PARAMETER_VALUE__SHOW_REMINDERS:
                ...
                break;
            case PARAMETER_VALUE__SHOW_SUMMARY:
                ...
                break;
            case PARAMETER_VALUE__SHOW_SEARCH:
    ...
    private AdminManagerSubreport createModifiedDocumentsSubreport(List<DocumentDomainObject> documentsFound) {
    ...
    private AdminManagerSubreport createNewDocumentsSubreport(List<DocumentDomainObject> documentsFound) {
        List<DocumentDomainObject> newDocuments = new ArrayList<>();
    ...
    private AdminManagerSubreport createDocumentsUnmodifiedForSixMonthsSubreport(List<DocumentDomainObject> documentsFound) {
        ...
        List<DocumentDomainObject> documentsUnchangedForSixMonths = new ArrayList<>();
    ...
    private AdminManagerSubreport createDocumentsArchivedWithinOneWeekSubreport(List<DocumentDomainObject> documentsFound) {
        LifeCyclePhase[] phases = new LifeCyclePhase[]{
                LifeCyclePhase.APPROVED,
                LifeCyclePhase.PUBLISHED
        };
        List<DocumentDomainObject> documentsArchivedWithinOneWeek = new ArrayList<>();
    ...
    private AdminManagerSubreport createDocumentsUnpublishedWithinOneWeekSubreport(List<DocumentDomainObject> documentsFound) {
        LifeCyclePhase[] phases = new LifeCyclePhase[]{
                LifeCyclePhase.APPROVED,
        ...
        Date lastMidnight = getDateLastMidnight();
        Date oneWeekAhead = getDateOneWeekAhead();
        List<DocumentDomainObject> documentsUnpublishedWithinOneWeek = new ArrayList<>();
        for (DocumentDomainObject document : documentsFound) {
            LifeCyclePhase phase = document.getLifeCyclePhase();
    ...
    public static class AdminManagerPage implements Serializable {
        ...
        String tabName;
        List<AdminManagerSubreport> subreports = new ArrayList<>();
        ...
        public List<AdminManagerSubreport> getSubreports() {
            return subreports;
        }
