...
public class DocDao {
    ...
    public List<Integer> getAllDocumentIds() {
        return docMetaDao.findAllIds();
    }


    public List<Integer> getDocumentIdsInRange(int min, int max) {
        return docMetaDao.findIdsBetween(min, max);
    }


    public Integer getMaxDocumentId() {
        return docMetaDao.findMaxId();
    }


    public Integer getMinDocumentId() {
        return docMetaDao.findMinId();
    }

    public Integer[] getMinMaxDocumentIds() {
        return docMetaDao.findMinAndMaxId();
    }
}