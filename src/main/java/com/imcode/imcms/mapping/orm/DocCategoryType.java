...
public class DocCategoryType implements Cloneable {
    ...
    public DocCategoryType() {
    }

    public DocCategoryType(String name, int maxChoices, boolean inherited, boolean imageArchive) {
        this(null, name, maxChoices, inherited, imageArchive);
    }

    public DocCategoryType(Integer id, String name, int maxChoices, boolean inherited, boolean imageArchive) {
        this.id = id;
        this.name = name;
    ...
    @Override
    public DocCategoryType clone() {
        try {
            return (DocCategoryType) super.clone();
    ...
    public boolean equals(Object obj) {
        return obj == this || (obj instanceof DocCategoryType && equals((DocCategoryType) obj));
    }

    private boolean equals(DocCategoryType that) {
