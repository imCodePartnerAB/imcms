...
public class FileController {
    ...
    @PutMapping("/{canOverWrite}")
    public Path saveFile(@RequestBody Path file, @PathVariable boolean canOverWrite) throws IOException {
        return defaultFileService.saveFile(file, canOverWrite);
    }
