<%@ page
		...
		import="com.imcode.imcms.api.DocumentLanguage,
				...
				com.imcode.imcms.servlet.Version,
 ...
 ******************************************************************************************* */
	...
	if (null != view) {
		isDocInfoMode = view.isMode(DocumentPermissionSetDomainObject.EDIT_DOCUMENT_INFORMATION);
		isEditMode = view.isMode(DocumentPermissionSetDomainObject.EDIT);
		isPermissionMode = view.isMode(DocumentPermissionSetDomainObject.EDIT_PERMISSIONS);
	}
	isNormalMode = (
	...
	<div id="imcmsToolBarMain">
		<div id="imcmsToolBarLeft">
			<table id="imcmsToolBarLeftTable" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td id="imcmsToolBarLogoTd"><img src="<%= cp %>/imcms/images/adminpanel/logo_imcms.gif" width="67"
													 height="15" alt=""/></td>
                    ...
                    !isEnabled ? " langIconDisabled" : "" %>"><%=
							href_0 %><img src="<%= cp %>/imcms/images/icons/flags_iso_639_1/<%= langCode %>.gif"
										  alt=""/><%
								if (!hasManyLanguages) {
							...
							<li id="imcmsMetaIdTd"><label>Page:</label> <%= document.getId() %>
							</li>
							<li><label>Alias:</label> <%= (null != document.getAlias()) ? document.getAlias() : "-" %>
							</li>
							<li><label>Template:</label> <%= templateName %><%
							%><%//= ", flags:" + view.getFlags() + ", isTemplateMode:" + isTemplateMode + ", view:" + (null != view) %>
							</li>
						</ul>
					</td>
				</tr>
			...
			<div class="tabsDiv">
				<table class="imcmsToolBarTabsTable" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>
							<button id="imcmsToolBarBtnBack" class="imcmsToolBarTab imcmsToolTip"
						...
						<td>
							<button id="imcmsToolBarBtnNormal"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isNormalMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton2_0.html/2001"/></button>
						</td>
						<%
							}
						...
						<td>
							<button id="imcmsToolBarBtnText"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isTextMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton2_65536.html/2001"/></button>
						</td>
						<td>
							<button id="imcmsToolBarBtnContentLoop"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isContentLoopMode ? " imcmsToolBarTabActive" : "" %>"
						...
						<td>
							<button id="imcmsToolBarBtnImage"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isImageMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton2_131072.html/2001"/></button>
						</td>
						<%
							}
							if (textDocumentPermissionSet.getEditMenus()) { %>
						<td>
							<button id="imcmsToolBarBtnLink"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isMenuMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton2_262144.html/2001"/></button>
						</td>
						<%
							}
							if (textDocumentPermissionSet.getEditTemplates()) { %>
						<td>
							<button id="imcmsToolBarBtnAppearance"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isTemplateMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton2_524288.html/2001"/></button>
						</td>
						<%
							}
							if (textDocumentPermissionSet.getEditIncludes()) { %>
						<td>
							<button id="imcmsToolBarBtnIncludes"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isIncludesMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton2_1048576.html/2001"/></button>
						</td>
						<%
								}
							}
						...
						<td>
							<button id="imcmsToolBarBtnEdit"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isEditMode ? " imcmsToolBarTabActive" : "" %>"
									onclick="imAdmGoTo(event, '<%= cp %>/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=65536'); return false"
									title="<fmt:message key="templates/sv/adminbuttons/adminbutton7_65536.html/2001" />"<%
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton7_65536.html/2001"/></button>
						</td>
						<%
							}
							if (documentPermissionSet.getEditDocumentInformation()) { %>
						<td>
							<button id="imcmsToolBarBtnDocInfo"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isDocInfoMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton_1.html/2002"/></button>
						</td>
						<%
							}
							if (documentPermissionSet.getEditPermissions()) { %>
						<td>
							<button id="imcmsToolBarBtnPermissions"
									class="imcmsToolBarTab imcmsToolBarTabMode<%= isPermissionMode ? " imcmsToolBarTabActive" : "" %>"
							...
							%>><fmt:message key="templates/sv/adminbuttons/adminbutton_4.html/2001"/></button>
						</td>
						<%
							} %>
					</tr>
		...
		<div id="imcmsToolBarRight">
			<div id="imcmsToolBarRightTop">
				<table border="0" cellspacing="0" cellpadding="0">
					<tr><%
						...
						<td><a href="<%= cp %>/servlet/LogOut" id="imcmsToolBarBtnLogOut"
							   class="imcmsToolBarLink imcmsToolTipRev"
						...
						%>
						<td><img id="imcmsToolBarHide" class="imcmsToolBarIconLink imcmsToolTipRev"
								 src="<%= cp %>/imcms/images/adminpanel/btn_hide_1.gif" alt=""
			...
			<div class="tabsDiv">
				<table class="imcmsToolBarTabsTable" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td>
							<button id="imcmsToolBarBtnHelp" class="imcmsToolBarTab imcmsToolTipRev"
									onclick="imcmsOpenHelpWin('HelpStart'); return false"
									title="<fmt:message key="templates/sv/adminbuttons/adminbuttons.html/2003" />"<%
							%>><fmt:message key="templates/sv/adminbuttons/adminbuttons.html/2004"/></button>
						</td>

						<td>
							<button id="imcmsToolBarBtnSettings" class="imcmsToolBarTab">Settings</button>
						</td>
						<%

							if (user.canAccessAdminPages()) { %>
						<td>
							<button id="imcmsToolBarBtnAdmin" class="imcmsToolBarTab imcmsToolTipRev"
							...
							%>><fmt:message key="templates/sv/adminbuttons/superadminbutton.html/2001"/></button>
						</td>
						<%
							} %>
					</tr>
				...
				<tr>
					<td style="white-space:nowrap;">
						<form action="<%= cp + "/" + document.getId()%>" method="post">
							<input type="hidden" name="<%=ImcmsConstants.REQUEST_PARAM__DOC_LANGUAGE%>"
								   value="<%=currentLanguage.getCode()%>"/>
							<select name="<%=ImcmsConstants.REQUEST_PARAM__DOC_VERSION%>" class="imcmsSelectBox"><%
								...
								<option value="<%=v.getNo()%>" <%= sSelected %>><%=(displayName)%>
								</option>
								<%
									} %>
							</select>
					...
					<td style="padding-left:10px; white-space:nowrap;">
						<form action="<%= cp %>/servlet/AdminDoc?meta_id=<%=document.getId()%>" method="post">
							<input type="text" size="3" name="no"
								   value="<%=documentVersionInfo.getDefaultVersion().getNo()%>" class="imcmsTextField"/>
							<input type="hidden" name="<%=ImcmsConstants.REQUEST_PARAM__DOC_LANGUAGE%>"
								   value="<%=currentLanguage.getCode()%>"/>
...
<div id="imcmsToolBarHidden">
	<div id="imcmsToolBarHiddenMain">
		<div id="imcmsToolBarShow" class="imcmsToolTipRev"
			 title="<fmt:message key="templates/sv/adminbuttons/adminbuttons.html/2005" />"></div>
		<div class="imcmsToolBarClear"></div>
	</div>
</div>
<%
...
<form name="changePageForm" method="post" action="<%= cp %>/servlet/SaveInPage">
	...
	<table border="0" cellspacing="0" cellpadding="2">
		<tr class="changePageTdBottom">
			...
			<td><input type="submit" name="change_group"
					   value="<fmt:message key="templates/sv/textdoc/inPage_admin.html/2001" />"
			...
			<td>
				<input type="submit" name="preview"
					   value="<fmt:message key="templates/sv/textdoc/inPage_admin.html/2002" />"
					   onclick="imcmsTargetNewWindow()" class="imcmsToolBarBtn"/></td>

			<td style="padding-left:10px;">
				<input type="submit" name="update"
					   value="<fmt:message key="templates/sv/textdoc/inPage_admin.html/2003" />"
