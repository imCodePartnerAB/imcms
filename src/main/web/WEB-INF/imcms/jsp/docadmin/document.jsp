...
<!-- Embedded menu app-->
<div style="width: 800px; height: 700px; border: 2px solid green;" id="doc-editor" class="v-app">
...
<script type="text/javascript">
    ...
    vaadin.initApplication("doc-editor", {
        "browserDetailsUrl": "<c:url value='/imcms/docadmin?docId=${requestScope.docId}'/>",
        "serviceUrl": "<c:url value='/imcms/docadmin/'/>",
