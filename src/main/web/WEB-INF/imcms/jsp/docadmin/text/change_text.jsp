...
vaadin.initApplication("text-editor", {
    "browserDetailsUrl": "<c:url value='/imcms/docadmin/text/?docId=${requestScope.docId}&textNo=${requestScope.textNo}'/>",
    "serviceUrl": "<c:url value='/imcms/docadmin/text/'/>",
