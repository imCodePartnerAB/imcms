...
<table border="0" cellspacing="0" cellpadding="2" width="656">
	...
	<tr>
		<td><span class="imcmsAdmHeading">
			...
			<br>(<%= documents.size() %> <? web/imcms/lang/jsp/admin/admin_manager.jsp/10 ?>)</span></td>
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td><input type="submit" class="imcmsFormBtnSmall" name="<%= subreportName %>_unexpand"
							   value="<? web/imcms/lang/jsp/admin/admin_manager.jsp/12 ?> &raquo;"></td>
					<%} else { %>
					<td><input type="submit" class="imcmsFormBtnSmall" name="<%= subreportName %>_expand"
							   value="<? web/imcms/lang/jsp/admin/admin_manager.jsp/11 ?> &raquo;"></td>
					<%}%>
				</tr>
			</table>
		</td>
		...
		<td colspan="2">
			<table border="0" cellspacing="0" cellpadding="2" width="100%">
				<tr valign="bottom">
					...
					<td><b><? web/imcms/lang/jsp/admin/admin_manager.jsp/17 ?>
						/<? web/imcms/lang/jsp/admin/admin_manager.jsp/18 ?></b></td>
					<td align="right" nowrap>
						<input type="submit" class="imcmsFormBtnSmall"
							   value="<? web/imcms/lang/jsp/admin/admin_manager_search.jsp/7 ?>">
						&nbsp;
