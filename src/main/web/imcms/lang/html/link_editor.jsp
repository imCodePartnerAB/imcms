...
<vel:velocity>
	...
	<body bgcolor="#FFFFFF" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0" class="imcmsAdmBgCont"
		  style="border:0; margin:0" onLoad="focusField(1,'createLinkDesc')">
	...
	<table border="0" cellspacing="0" cellpadding="0">
		<form>
			<tr>
				<td><input type="button" class="imcmsFormBtn"
						   value="<? install/htdocs/imcms/html/link_editor.jsp/2001 ?>"
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<tr>
							...
							<td><input type="text" name="createLinkDesc" size="54" maxlength="255" style="width: 100%"
									   value="<? install/htdocs/imcms/html/link_editor.jsp/6/1 ?>"></td>
						</tr>
						<tr>
							<td class="imcmsAdmText"><? install/htdocs/imcms/html/link_editor.jsp/7 ?></td>
							<td class="form">
								<select class="form" name="createLinkType"
										onChange="changeLinkType(document.forms.createLinkForm.createLinkType.options[document.forms.createLinkForm.createLinkType.selectedIndex].value)">
						...
						<tr>
							<td class="imcmsAdmText" nowrap><? install/htdocs/imcms/html/link_editor.jsp/1001 ?>
								&nbsp;</td>
							<td>
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td nowrap>
											<select name="createLinkTargetTemp"
												...
												<option value=""
														selected><? install/htdocs/imcms/html/link_editor.jsp/14 ?></option>
										...
										<td>&nbsp;</td>
										<td class="form" align="right"><input type="text" name="createLinkTarget"
						...
						<tr>
							...
							<td><input type="text" name="createLinkValue" size="54" maxlength="100" style="width: 100%"
									   value="<? install/htdocs/imcms/html/link_editor.jsp/21/1 ?>"></td>
						</tr>
						<tr>
							<td class="imcmsAdmText" nowrap><? install/htdocs/imcms/html/link_editor.jsp/22 ?></td>
							<td><input type="text" name="createLinkCss" size="20" maxlength="50" style="width: 150%"
									   value=""></td>
						</tr>
						<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td><input type="submit"
												   value="<? install/htdocs/imcms/html/link_editor.jsp/2002 ?>"
												   class="imcmsFormBtnSmall" width="120" style="width:120%"
												   onClick="createLink();"></td>
										<td>&nbsp;</td>
										<td><input type="reset"
												   value="<? install/htdocs/imcms/html/link_editor.jsp/2003 ?>"
												   class="imcmsFormBtnSmall" onClick="hideLinkExample(0);"></td>
									</tr>
								</table>
							</td>
						</tr>
						<tr>
							<td colspan="2" nowrap>&nbsp;<br>#gui_heading(
								"<? install/htdocs/imcms/html/link_editor.jsp/25/1 ?>" )
							</td>
						</tr>
						<tr>
							<td colspan="2"><input type="text" name="theLinkCodeField" size="76" maxlength="255"
												   style="width: 100%" value="">

								<div id="theLinkCodeFieldDiv"></div>
							</td>
						</tr>
						<tr>
							<td><img src="$contextPath/imcms/$language/images/admin/1x1.gif" width="105" height="1">
							</td>
	...
	<script language="javascript">
		...
		var arrTheFieldValues = ["<? install/htdocs/imcms/html/link_editor.jsp/21/1 ?>", "http:/\/", "<? install/htdocs/imcms/html/link_editor.jsp/3002 ?>", "<? install/htdocs/imcms/html/link_editor.jsp/3003 ?>", "<? install/htdocs/imcms/html/link_editor.jsp/3003 ?>", "ftp:/\/"];
