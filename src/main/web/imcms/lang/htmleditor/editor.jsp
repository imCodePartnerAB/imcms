...
<%!
	...
	public void setCookie(String name, String value, HttpServletResponse res) {
	...
	public String getRequestParam(HttpServletRequest request, String param) {
		return Optional.of(request.getParameter(param)).orElse("");
	}
...
%><%
	...
	String meta_id = getRequestParam(request, "meta_id");
	String txt_no = getRequestParam(request, "txt");
	String label = getRequestParam(request, "label");
...
<html>
<head>
	<title>&nbsp; <? install/htdocs/sv/htmleditor/editor/editor.jsp/1001 ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		&nbsp;</title>
...
<body unselectable="off" bgcolor="#D6D3CE" style="background-color:buttonface; border: 1px solid buttonface;"
	  onLoad="init();" onUnLoad="if (parent.opener) parent.opener.location.reload();">
...
<form name="editorForm" onSubmit="return false">
	...
	<DIV style="position:absolute; left:0; top:0">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr bgcolor="#333366">
				<td height="20" style="font: 11px Verdana,Geneva,Arial,Helvetica,sans-serif; color:#FFFFFF">
					<img src="images/1x1.gif" width="10"
						 height="1"><? install/htdocs/sv/htmleditor/editor/editor.jsp/2/1 ?>
					<b style="font-size:12px"><%= txt_no %>
					</b><%
					if (!label.equals("")) {
				...
				%>
					...
					<b style="font-size:12px"><%= meta_id %>
					</b></td>
				<td align="right">
		...
		<div align="center" style="position:absolute; left:-1; top:20; width:665; height:60; z-index:2; text-align:left"
			 unselectable="on">
		...
		<div id="editorOuterDiv" unselectable="off"
			 style="position:absolute; left:5; top:80; width:525; height:380; z-index:3; background-color:white; text-align: left; padding:0; border: 2px inset #D6D3CE">
		</div>
		<div id="editorDiv" contenteditable unselectable="off"
			 style="position:absolute; left:5; top:80; width:525; height:380; z-index:4; background-color:white; text-align: left; padding:3; border: 2px inset #D6D3CE; scrollbar-base-color:#D6D3CE; overflow:auto"
			 onKeyUp="if (isWordEnabled && preview) checkWordCode(this.innerHTML)"
			 onMouseUp="if (isWordEnabled && preview) checkWordCode(this.innerHTML)"
			 onChange="if (isWordEnabled && preview) checkWordCode(this.innerHTML)"></div>


		<!-- ***** Right panel - SIMPLE ***** -->

		<div id="modeSimpleDiv" style="position:absolute; left:535; top:80; z-index:5; visibility:hidden"
			 unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="141">
				<tr>
					<td align="center" bgcolor="#333366" height="22">
						<b style="color:#ffffff"
						   id="simpleHeadingText"><? install/htdocs/sv/htmleditor/editor/editor.jsp/7 ?></b></td>
				</tr>
				<tr>
		...
		<div id="modeSimpleLinkDiv"
			 style="position:absolute; left:535; top:155; width:141; z-index:6; visibility:hidden;" unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><? install/htdocs/sv/htmleditor/editor/editor.jsp/9 ?></td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1"
							 height="5"><? install/htdocs/sv/htmleditor/editor/editor.jsp/10 ?></td>
				</tr>
				<tr>
					<td>
						<select name="createLinkType" unselectable="On" onChange="changeLinkType(this.value)"
								style="width:140">
				...
				<tr>
					<td><img src="images/1x1.gif" width="1"
							 height="5"><? install/htdocs/sv/htmleditor/editor/editor.jsp/15 ?></td>
				</tr>
				<tr>
					<td>
						<select name="createLinkTargetTemp" unselectable="On"
								onChange="document.forms[0].createLinkTarget.value = this.value; document.forms[0].createLinkTarget.focus(); document.forms[0].createLinkTarget.select()"
								style="width:140">
				...
				<tr>
					<td><input type="text" name="createLinkTarget" value="" size="12" maxlength="50"
							   style="width:140"><br>
				...
				<tr>
					<td id="createLinkField"><input type="text" name="createLinkValue" value="" size="5" maxlength="6"
													style="width:42; text-align:right"></td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1"
							 height="5"><? install/htdocs/sv/htmleditor/editor/editor.jsp/23 ?></td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td><input type="text" name="createLinkCss" value="" size="12" maxlength="50" style="width:140">
					</td>
				</tr>
				<tr>
					<td align="center"><img src="images/1x1.gif" width="1" height="5"><br>
						<button unselectable="on" name="CreateLink" id="CreateLink"
								title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2001 ?>"
								class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1002 ?></button>
					</td>
				</tr>
				<tr>
		...
		<div id="modeSimpleListDiv"
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td><img src="images/1x1.gif" width="1"
							 height="5"><? install/htdocs/sv/htmleditor/editor/editor.jsp/27 ?></td>
				</tr>
				<tr>
					<td>
						<select name="createListType" unselectable="On" onChange="changeListType(this.value)"
								style="width:140">
			...
			<DIV id="listCountTypeDiv" style="position:relative; visibility:hidden" unselectable="On">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td><img src="images/1x1.gif" width="1"
								 height="5"><? install/htdocs/sv/htmleditor/editor/editor.jsp/31 ?></td>
					</tr>
					<tr>
						<td>
							<select name="createListOLType" unselectable="On" style="width:140">
								<option value="1"
										selected><? install/htdocs/sv/htmleditor/editor/editor.jsp/32 ?></option>
			...
			<DIV id="listCountDiv" style="position:relative; top:-25" unselectable="On">
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td><img src="images/1x1.gif" width="1"
								 height="5"><? install/htdocs/sv/htmleditor/editor/editor.jsp/39 ?></td>
					</tr>
					<tr>
						<td>
							<SCRIPT LANGUAGE="JavaScript1.2">
					...
					<tr>
						<td><input type="text" name="createListCss" value="" size="12" maxlength="50" style="width:140">
						</td>
					</tr>
					<tr>
						<td align="center"><img src="images/1x1.gif" width="1" height="5"><br>
							<button unselectable="on" name="CreateList" id="CreateList"
									title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2002 ?>"
									class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1003 ?></button>
						</td>
					</tr>
					<tr>
						<td><img src="images/1x1.gif" width="1" height="15"><br>
		...
		<div id="modeSimplePixelDiv"
			...
			<table border="0" cellpadding="0" cellspacing="0">
					...
					<td>
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td align="right"><input type="text" name="pixelWidth" value="1" size="4" maxlength="4"
														 style="text-align:right; width:35"></td>
							</tr>
							<tr>
								<td><? install/htdocs/sv/htmleditor/editor/editor.jsp/44 ?></td>
								<td align="right"><input type="text" name="pixelHeight" value="8" size="4" maxlength="4"
														 style="text-align:right; width:35"></td>
							</tr>
							<tr>
								<td><? install/htdocs/sv/htmleditor/editor/editor.jsp/45 ?></td>
								<td align="right"><input type="text" name="pixelBorder" value="0" size="4" maxlength="4"
														 style="text-align:right; width:35"></td>
							</tr>
							<tr>
								...
								<td align="right">
									<select name="pixelAlign" unselectable="On" style="width:85">
										<option value=""
												selected><? install/htdocs/sv/htmleditor/editor/editor.jsp/47 ?></option>
							...
							<tr>
								<td align="center"><input type="checkbox" unselectable="On" name="pixelBreakStart"
														  value="1"></td>
								<td align="center"><input type="checkbox" unselectable="On" name="pixelBreakEnd"
														  value="1"></td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td align="center"><img src="images/1x1.gif" width="1" height="5"><br>
						<button unselectable="on" name="CreatePixel" id="CreatePixel"
								title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2003 ?>"
								class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1004 ?></button>
					</td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1" height="15"><br>
	...
	<img src="images/1x1.gif" width="1" height="5"><br>
		...
		<div id="modeAdvancedDiv" style="position:absolute; left:535; top:80; width:141; z-index:5; visibility:hidden"
			 unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="141">
				<tr>
					<td align="center" bgcolor="#333366" height="22"><b style="color:#ffffff"
																		id="advHeadingText"><? install/htdocs/sv/htmleditor/editor/editor.jsp/61/1 ?></b>
					</td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1" height="5"></td>
				...
				<tr>
					<td>
						<SCRIPT LANGUAGE="JavaScript">
							...
							var onCountAdv = 0;
							if (showAdv) {
								if (showAdv < ? install / htdocs / sv / htmleditor / editor / editor.jsp / 62 / 4 ?>
								Div
							)
								onCountAdv++;
								...
								if (showAdv < ? install / htdocs / sv / htmleditor / editor / editor.jsp / 62 / 3 ?>
								Div
							)
								onCountAdv++;
								...
								if (onCountAdv > 1) {
									...
									} else if (showAdv < ? install / htdocs / sv / htmleditor / editor / editor.jsp / 62 / 3 ?>
									Div
								)
									{
										document.write('<b>Inst�llningar</b>');
		...
		<div id="modeAdvStandardDiv"
			 style="position:absolute; left:535; top:150; width:141; z-index:5; visibility:hidden" unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="140">
				<tr>
					<td nowrap><? install/htdocs/sv/htmleditor/editor/editor.jsp/63 ?></td>
					<td align="right">
						<button id="btn26" class="button" unselectable="on" onClick="collectTableInfo()"
								title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2004 ?>">
							<img src="images/btn_table.gif"></button>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" nowrap>
						...
						<div align="center">
							<button id="btn27" unselectable="on" onClick="doFormatBlock();"
									class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1007 ?></button>
						</div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="right">
						<button id="btn28" class="button" unselectable="On"
								onClick="doExecCommand('InsertHorizontalRule',true,null);"
								title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2005 ?>">
							<img src="images/btn_hr.gif"></button>
					</td>
				</tr>
				<tr>
					<td colspan="2" height="10">
				...
				<tr style="display:none"><!-- disconnected -->
					...
					<td align="right">
						<button id="btn29" class="button" unselectable="On"
								onClick="javascript://doExecCommand('InsertImage',true,null);"
								title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2006 ?>">
							<img src="images/btn_image.gif"></button>
					</td>
				</tr>
				<tr style="display:none"><!-- disconnected -->
					<td colspan="2" height="10">
				...
				<tr>
					...
					<td align="right">
						<button id="btn30" unselectable="on" class="button" onClick="dummyText();"
								title="<? install/htdocs/sv/htmleditor/editor/editor.jsp/2007 ?>">
		...
		<div id="modeAdvFontClassDiv"
			 style="position:absolute; left:535; top:155; width:141; z-index:5; visibility:hidden" unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="140">
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="useClass11" value="- Annan Class" size="12" maxlength="50"
							   style="width:119" onKeyDown="document.forms[0].useClass[10].checked = 1;"></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><img src="images/1x1.gif" width="1" height="5"><br>
						<button unselectable="on" name="classBtn" id="classBtn"
								class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1009 ?></button>
					</td>
				</tr>
			</table>
		</div>
		...
		*****************************************************************************************
		...
		<div id="modeAdvFontStyleDiv"
			...
			<input type="checkbox" name="usecolor"
				   value="1"><b><? install/htdocs/sv/htmleditor/editor/editor.jsp/103/1 ?></b><br>
			<img src="images/1x1.gif" width="1" height="60"><br>

			<div align="center">
				<button unselectable="on" name="styleBtn" id="styleBtn"
						class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1011 ?></button>
			</div>
		</div>


		<div id="modeAdvCodeStringDiv"
			 style="position:absolute; left:535; top:155; width:141; z-index:5; visibility:hidden" unselectable="on">
			<b><? install/htdocs/sv/htmleditor/editor/editor.jsp/104/1 ?></b><br>
			<textarea cols="15" rows="7" name="startCode" wrap="soft" class="fFieldSmall"
					  style="width:140"></textarea><br>
			<img src="images/1x1.gif" width="1" height="5"><br>
			<b><? install/htdocs/sv/htmleditor/editor/editor.jsp/105/1 ?></b><br>
			<textarea cols="15" rows="3" name="endCode" wrap="soft" class="fFieldSmall"
					  style="width:140"></textarea><br>
			<img src="images/1x1.gif" width="1" height="5"><br>

			<div align="center">
				<button unselectable="on" name="codeBtn" id="codeBtn"
						class="fButtonSmall"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1012 ?></button>
			</div>
		</div>


		<div id="modeAdvSettingsDiv"
			 style="position:absolute; left:535; top:155; width:141; z-index:5; visibility:hidden" unselectable="on">
			<? install/htdocs/sv/htmleditor/editor/editor.jsp/1013 ?>
			<img src="images/1x1.gif" width="1" height="5"><br>
			<b><? install/htdocs/sv/htmleditor/editor/editor.jsp/106/1 ?></b> <SPAN
				STYLE="color:CC0000"><sup><? install/htdocs/sv/htmleditor/editor/editor.jsp/107 ?></sup></SPAN><br>
			...
			<input type="text" name="previewBackground" value="rgb(255,255,255)" size="15" maxlength="30"
				   style="width:140"><br>
			<img src="images/1x1.gif" width="1" height="5"><br>
			...
			<div align="center">
				<button unselectable="on" class="fButtonSmall"
						onClick="setDefaultValues('do'); saveSettings('EditorSettings')"
						style="width:80"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1014 ?></button>
				<button unselectable="on" class="fButtonSmall"
						onClick="setDefaultValues('reset'); saveSettings('EditorSettings')"
						style="width:60"><? install/htdocs/sv/htmleditor/editor/editor.jsp/110 ?></button>
			</div>
			<img src="images/1x1.gif" width="1" height="5"><br>
<SPAN CLASS="dim"><? install/htdocs/sv/htmleditor/editor/editor.jsp/111 ?>
	...
	<? install/htdocs/sv/htmleditor/editor/editor.jsp/112/1 ?></SPAN><br>
			<img src="images/1x1.gif" width="1" height="5"><br>
			<SPAN STYLE="color:CC0000"><sup><? install/htdocs/sv/htmleditor/editor/editor.jsp/113 ?></sup></SPAN><SPAN
				CLASS="dim">&nbsp;<? install/htdocs/sv/htmleditor/editor/editor.jsp/1015 ?></SPAN>
		...
		*****************************************************************************************
				...
				<tr>
					...
					<td><%
						...
						<button id="editorOnOffBtn1" onClick="toggleEditorOnOff(1);"
								class="fButtonSmall"
								style="width:40; border-style:inset; display:none"><? global/on ?></button>
						<%
						} else { %>
						<button id="editorOnOffBtn0" onClick="toggleEditorOnOff(0);"
		...
		<div id="disableTopBtnDiv"
			 style="position:absolute; left:10; top:22; width:535; height:57; z-index:100; background-color:#D6D3CE; filter:Alpha(Opacity=60); visibility:hidden"></div>

		<div id="disableRightBtnDiv"
			 style="position:absolute; left:535; top:102; width:143; height:355; z-index:100; background-color:#D6D3CE; filter:Alpha(Opacity=60); visibility:hidden"></div>

		<div id="disableBottomBtnDiv"
			 style="position:absolute; left:5; top:462; width:674; height:33; z-index:100; background-color:#D6D3CE; filter:Alpha(Opacity=60); visibility:hidden"></div>


		<div id="modeHtmlCodeDiv" style="position:absolute; left:535; top:80; z-index:4; visibility:hidden"
			 unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="141">
				<tr>
					<td align="center" bgcolor="#333366"
						height="22"><? install/htdocs/sv/htmleditor/editor/editor.jsp/117 ?></td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1" height="5"></td>
				</tr>
		...
		<div id="helpDescRightDiv" style="position:absolute; left:535; top:80; z-index:4; visibility:hidden"
			 unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="141">
				<tr>
					<td align="center" bgcolor="#333366"
						height="22"><? install/htdocs/sv/htmleditor/editor/editor.jsp/120 ?></td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1" height="5"></td>
				</tr>
				<tr>
					<td><? install/htdocs/sv/htmleditor/editor/editor.jsp/121 ?>
						<script language="JavaScript">
							<!--
		...
		<div id="helpAllDescRightDiv" style="position:absolute; left:535; top:80; z-index:4; visibility:hidden"
			 unselectable="on">
			<table border="0" cellpadding="0" cellspacing="0" width="141">
				<tr>
					<td align="center" bgcolor="#333366"
						height="22"><? install/htdocs/sv/htmleditor/editor/editor.jsp/123 ?></td>
				</tr>
				<tr>
					<td><img src="images/1x1.gif" width="1" height="5"></td>
				</tr>
...
<div id="modeColorDiv" style="position:absolute; left:535; top:140; z-index:10; visibility:hidden" unselectable="on">
	<form name="colorForm">
		<table border="0" cellspacing="0" cellpadding="0" align="center">
			<tr>
				<td>
					<DIV ID="theColorRedDiv"><img src="images/1x1.gif" width="25" height="2"></DIV>
					<input unselectable="off" type="text" id="fRed" size="3" maxlength="3" class="fField" value="0"
						   style="width:25; height:19" onChange="showColor();" onKeyUp="showColor();"
						   onKeyPress="showColor();"></td>
				<td><a href="#" unselectable="on"><img src="images/btn_adjust_up_down.gif" width="15" height="21" alt=""
													   border="0" usemap="#fRed"></a></td>
				<td><img src="images/1x1.gif" width="5" height="1"></td>
				<td>
					<DIV ID="theColorGreenDiv"><img src="images/1x1.gif" width="25" height="2"></DIV>
					<input unselectable="off" type="text" id="fGreen" size="3" maxlength="3" class="fField" value="0"
						   style="width:25; height:19" onChange="showColor();" onKeyUp="showColor();"
						   onKeyPress="showColor();"></td>
				<td><a href="#" unselectable="on"><img src="images/btn_adjust_up_down.gif" width="15" height="21" alt=""
													   border="0" usemap="#fGreen"></a></td>
				<td><img src="images/1x1.gif" width="5" height="1"></td>
				<td>
					<DIV ID="theColorBlueDiv"><img src="images/1x1.gif" width="25" height="2"></DIV>
					<input unselectable="off" type="text" id="fBlue" size="3" maxlength="3" class="fField" value="0"
						   style="width:25; height:19" onChange="showColor();" onKeyUp="showColor();"
						   onKeyPress="showColor();"></td>
				<td><a href="#" unselectable="on"><img src="images/btn_adjust_up_down.gif" width="15" height="21" alt=""
													   border="0" usemap="#fBlue"></a></td>
			</tr>
			<tr>
				<td colspan="8">
					<DIV ID="theColorDiv"></DIV>
					<DIV id="theColorText" unselectable="on">rgb(0,0,0)</DIV>
				</td>
			</tr>
		</table>
	</form>
...
<div id="helpDiv" unselectable="off"
	 style="position:absolute; left:5; top:80; width:525; height:380; z-index:200; background-color:#FFFFE0; text-align: left; padding:0; border: 2px inset #D6D3CE; visibility: hidden">
	<table border="0" cellpadding="5" cellspacing="0" width="100%">
		<tr>
			<td CLASS="imEditHelpHeadingBig"><? install/htdocs/sv/htmleditor/editor/editor.jsp/129 ?></td>
			<td align="right">
				<button id="hideHelpBtn" class="fButtonSmall"
						onClick="hideHelp('all');"><? install/htdocs/sv/htmleditor/editor/editor.jsp/130 ?></button>
			</td>
		</tr>
	</table>
</div>
...
<div id="helpSubjectDiv" contenteditable="false" unselectable="off"
	 style="position:absolute; left:5; top:120; width:525; height:338; z-index:201; text-align: left; padding:0; visibility:hidden; overflow=auto"
	 class="imEditHelp">
...
<div id="helpTextAllDiv" contenteditable="false" unselectable="off"
	 style="position:absolute; left:5; top:80; width:525; height:380; z-index:201; text-align: left; padding:5; visibility:hidden; background-color:#FFFFE0; border: 2px inset #D6D3CE; overflow=auto">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td CLASS="imEditHelpHeadingBig"><? install/htdocs/sv/htmleditor/editor/editor.jsp/131 ?></td>
			<td align="right">
				<button class="fButtonSmall"
						onClick="hideHelp('all');"><? install/htdocs/sv/htmleditor/editor/editor.jsp/132 ?></button>
			</td>
		</tr>
	</table>
	<br>

	<b>|&nbsp; <span class="imEditHelpLinkActive"><? install/htdocs/sv/htmleditor/editor/editor.jsp/133 ?></span> &nbsp;|&nbsp;
		<a href="javascript:showHelp('upperbuttons');"
		   class="imEditHelpLink"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1018/1 ?></a> &nbsp;|&nbsp; <a
				href="javascript:showHelp('rightbuttons');"
				class="imEditHelpLink"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1018/2 ?></a> &nbsp;|&nbsp;</b><br><br>
	...
	nisl ut aliquip ex ea commodo consequat.<br><br>
...
<div id="helpTextAllUpperDiv" contenteditable="false" unselectable="off"
	 style="position:absolute; left:5; top:80; width:525; height:380; z-index:201; text-align: left; padding:5; visibility:hidden; background-color:#FFFFE0; border: 2px inset #D6D3CE; overflow=auto"
	 class="imEditHelp">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td align="right">
				<button class="fButtonSmall"
						onClick="hideHelp('all');"><? install/htdocs/sv/htmleditor/editor/editor.jsp/137 ?></button>
			</td>
		</tr>
	</table>
	<br>

	<b>|&nbsp; <a href="javascript:showHelp('all');"
				  class="imEditHelpLink"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1019/1 ?></a> &nbsp;|&nbsp;
		<span class="imEditHelpLinkActive"><? install/htdocs/sv/htmleditor/editor/editor.jsp/138 ?></span> &nbsp;|&nbsp;
		<a href="javascript:showHelp('rightbuttons');"
		   class="imEditHelpLink"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1020/1 ?></a> &nbsp;|&nbsp;
	</b><br><br>
	...
	Duis autem, vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu
	feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit
	augue duis dolore te feugait nulla facilisi.<br><br>
...
<div id="helpTextAllRightDiv" contenteditable="false" unselectable="off"
	 style="position:absolute; left:5; top:80; width:525; height:380; z-index:201; text-align: left; padding:5; visibility:hidden; background-color:#FFFFE0; border: 2px inset #D6D3CE; overflow=auto"
	 class="imEditHelp">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td align="right">
				<button class="fButtonSmall"
						onClick="hideHelp('all');"><? install/htdocs/sv/htmleditor/editor/editor.jsp/142 ?></button>
			</td>
		</tr>
	</table>
	<br>
	...
	<b>|&nbsp; <a href="javascript:showHelp('all');"
				  class="imEditHelpLink"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1021/1 ?></a> &nbsp;|&nbsp;
		<a href="javascript:showHelp('upperbuttons');"
		   class="imEditHelpLink"><? install/htdocs/sv/htmleditor/editor/editor.jsp/1021/2 ?></a> &nbsp;|&nbsp; <span
				class="imEditHelpLinkActive"><? install/htdocs/sv/htmleditor/editor/editor.jsp/143 ?></span> &nbsp;|&nbsp;
	</b><br><br>
...
<div id="waitingDiv"
	 style="position:absolute; left:5; top:463; width:400; height:30; z-index:1000; text-align:left; padding:5; background-color:#D6D3CE; display:none"
	 class="imEditHelpHeadingBig" style="font-size:20px"><? install/htdocs/sv/htmleditor/editor/editor.jsp/146 ?></div>

<div id="theOriginalCodeDiv" contenteditable style="position:absolute; left:-5000; top:-5000"><%= orgContent %>
</div>

<div id="theSavedCodeDiv" contenteditable style="position:absolute; left:-5000; top:-5000"><%= txtContent %>
</div>
