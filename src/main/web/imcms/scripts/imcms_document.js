...
Imcms.Document.Editor.prototype = {
    ...
    buildView: function () {
        ...
        this._builder = new JSFormBuilder("<DIV>")
            ...
            .setClass("imcms-text-field imcms-element")
            .on("input", function () {
            ...
            .setClass("imcms-neutral imcms-element")
            ...
            .button()
            .id("addSelectedDE")
            .setClass("imcms-positive create-new hidden")
            .html("Add selected…")
            .on("click", $.proxy(this.addSelected, this))
            .end()

            .button()
            .setClass("imcms-positive hidden pluralCopyArchButton")
            .html("Copy")
...
Imcms.Document.Viewer.prototype = {
    ...
    buildView: function () {
        this._builder = JSFormBuilder("<div>")
            ...
            .end()
            .div()
            .setClass("imcms-content with-tabs")
            .div()
            .setClass("imcms-tabs")
            .reference("tabs")
            .end()
            .div()
            .setClass("imcms-pages")
            .reference("pages")
            .end()
            .end()
            .div()
            ...
            .setClass("buttons")
            .button()
            .setClass("imcms-positive")
            .html("OK")
            .on("click", this.apply.bind(this))
            .end()
            .button()
            .setClass("imcms-neutral")
            .html("Cancel")
            .on("click", this.cancel.bind(this))
            .end()
            .button()
            .id("save-and-publish-button")
            .setClass("imcms-negative versioning" + (this.shouldSaveVersionBeHidden() ? " hidden" : ""))
    ...
    buildLifeCycle: function () {
        this._builder.ref("tabs")
            ...
            .setClass("life-cycle-tab imcms-tab")
            .html("Life Cycle")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("life-cycle-page")
            .setClass("life-cycle-page imcms-page")
            .div()
            .setClass("select field")
            .select()
            .name("status")
            ...
            .setClass("field versioning" + (this.shouldSaveVersionBeHidden() ? " hidden" : ""))
            .div()
            .setClass("field")
    ...
    buildAppearance: function () {
        this._builder.ref("tabs")
            ...
            .setClass("appearance-tab imcms-tab active")
            .html("Appearance")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("appearance-page")
            .setClass("appearance-page imcms-page active")
            .div()
            .setClass("language field")
            .reference("languages")
            .end()
            .div()
            .setClass("link-action field")
            .select()
            .name("target")
            .label("Show in")
    ...
    buildTemplates: function () {
        this._builder.ref("tabs")
            ...
            .setClass("templates-tab imcms-tab")
            .html("Templates")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("templates-page")
            .setClass("templates-page imcms-page")
            .div()
            .setClass("select field")
            .select()
            .name("template")
    ...
    buildPermissions: function () {
        this._builder.ref("tabs")
            ...
            .setClass("permissions-tab imcms-tab")
            .html("Permissions")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("permissions-page")
            .setClass("permissions-page imcms-page")
            .div()
            .setClass("imcms-column")
            .div()
            .setClass("imcms-label")
            .html("Restricted 1")
            .end()
            .div()
            .setClass("field")
    ...
    buildLinking: function () {
        this._builder.ref("tabs")
            ...
            .setClass("linking-tab imcms-tab")
            .html("Linking")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("linking-page")
            .setClass("linking-page imcms-page")
            .div()
            .setClass("field")
            .text()
            .name("url")
    ...
    buildFile: function () {
        this._builder.ref("tabs")
            .div()
            .reference("file-tab")
            .setClass("file-tab imcms-tab")
            .html("File")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("file-page")
            .setClass("file-page imcms-page")
            .div()
            .setClass("select field")
    ...
    buildAccess: function () {
        this._builder.ref("tabs")
            ...
            .setClass("access-tab imcms-tab")
            .html("Access")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("access-page")
            .setClass("access-page imcms-page")
            .table()
            .reference("access")
            .column("Role")
            .column("View")
    ...
    buildKeywords: function () {
        this._builder.ref("tabs")
            ...
            .setClass("keywords-tab imcms-tab")
            .html("Keywords")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("keywords-page")
            .setClass("keywords-page imcms-page")
            .div()
            .setClass("field")
            .text()
            .label("Keyword text")
    ...
    buildCategories: function () {
        this._builder.ref("tabs")
            ...
            .setClass("categories-tab imcms-tab")
            .html("Categories")
            .end();
        this._builder.ref("pages")
            .div()
            .reference("categories-page")
            .setClass("categories-page imcms-page")
            .end();
    ...
    buildDates: function () {
        this._builder.ref("tabs")
            .div()
            .reference("dates-tab")
            .setClass("dates-tab imcms-tab")
            .html("Status")
            .end();
        this._builder.ref("pages")
            .div().reference("dates-page").setClass("dates-page imcms-page")
    ...
    addCategoryType: function (categoryType, options) {
        ...
        if (options.isMultiple) {
            this._builder.ref(categoryType).setClass("pqSelect").multiple();
        }
        else {
            this._builder.ref(categoryType)
                .option("none", "");
