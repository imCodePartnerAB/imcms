...
<%
    ...
    textDocument.setHeadline(I18nContentSupport.getCurrentLanguage(), "Textdocument created from API" );
...
<%
    ...
    urlDocument.setHeadline(I18nContentSupport.getCurrentLanguage(),  "URL-document created from API" );
...
<%
    ...
    fileDocument.setHeadline(I18nContentSupport.getCurrentLanguage(),  "Filedocument created from API");
