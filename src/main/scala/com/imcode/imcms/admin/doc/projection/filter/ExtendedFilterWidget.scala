...
class ExtendedFilterWidget extends CustomLayout("admin/doc/projection/extended_filter") with UndefinedSize {

  object dates {
    val chkEnabled = new CheckBox("docs_projection.extended_filter.chk_dates".i) with Immediate

    val drCreated = new DateRangeWidget("docs_projection.extended_filter.dr_created".i) with DateRangeWidgetSetup
    val drModified = new DateRangeWidget("docs_projection.extended_filter.dr_modified".i) with DateRangeWidgetSetup
    val drPublished = new DateRangeWidget("docs_projection.extended_filter.dr_published".i) with DateRangeWidgetSetup
    val drArchived = new DateRangeWidget("docs_projection.extended_filter.dr_archived".i) with DateRangeWidgetSetup
    val drExpired = new DateRangeWidget("docs_projection.extended_filter.dr_expired".i) with DateRangeWidgetSetup
  }
  ...
  object maintainers {
    ...
    val ulCreators = new UserListWidget("docs_projection.extended_filter.chk_maintainers_creators".i) with UserListWidgetSetup {
      val projectionDialogCaption = "docs_projection.extended.dlg_select_creators.caption".i
    }

    val ulPublishers = new UserListWidget("docs_projection.extended_filter.chk_maintainers_publishers".i) with UserListWidgetSetup {
