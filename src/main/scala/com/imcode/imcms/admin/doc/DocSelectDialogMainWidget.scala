...
import com.imcode.imcms.admin.doc.projection.DocsProjectionWidget

class DocSelectDialogMainWidget(docsProjectionWidget: DocsProjectionWidget) extends VerticalLayout with Spacing with FullSize {
  ...
  this.addComponents(mb, docsProjectionWidget)
  setExpandRatio(docsProjectionWidget, 1f)
}
