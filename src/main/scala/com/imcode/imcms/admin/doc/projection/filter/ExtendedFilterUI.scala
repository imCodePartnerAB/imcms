...
class ExtendedFilterUI extends CustomLayout("admin/doc/projection/extended_filter") with UndefinedSize {

  object dates {
    val chkEnabled = new CheckBox("docs_projection.extended_filter.chk_dates".i) with Immediate

    val drCreated = new DateRangeUI("docs_projection.extended_filter.dr_created".i) with DateRangeUISetup
    val drModified = new DateRangeUI("docs_projection.extended_filter.dr_modified".i) with DateRangeUISetup
    val drPublished = new DateRangeUI("docs_projection.extended_filter.dr_published".i) with DateRangeUISetup
    val drArchived = new DateRangeUI("docs_projection.extended_filter.dr_archived".i) with DateRangeUISetup
    val drExpired = new DateRangeUI("docs_projection.extended_filter.dr_expired".i) with DateRangeUISetup
  }
  ...
  object maintainers {
    ...
    val ulCreators = new UserListUI("docs_projection.extended_filter.chk_maintainers_creators".i) with UserListUISetup {
      val projectionDialogCaption = "docs_projection.extended.dlg_select_creators.caption".i
    }

    val ulPublishers = new UserListUI("docs_projection.extended_filter.chk_maintainers_publishers".i) with UserListUISetup {
