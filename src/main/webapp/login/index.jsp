    ...
    %><p><b><%= error.toLocalizedString(request) %></b></p><%
        ...
        %>
            ...
            <img alt=""
                 ...
                 width="1" height="5"><fmt:message key="templates/login/index.html/1001"/></span></td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
    </tr>
            ...
            <table border="0" cellspacing="0" cellpadding="1">
                <form action="<%= request.getContextPath() %>/servlet/VerifyUser" method="post">
                    ...
                    <input type="hidden" name="<%= VerifyUser.REQUEST_PARAMETER__NEXT_META %>"
                           value="<%=StringEscapeUtils.escapeHtml4(next_meta)%>">
                    <%} else if (null != next_url) { %>
                    <input type="hidden" name="<%= VerifyUser.REQUEST_PARAMETER__NEXT_URL %>"
                           value="<%=StringEscapeUtils.escapeHtml4(next_url)%>">
                    <%}%>
                    <tr>
