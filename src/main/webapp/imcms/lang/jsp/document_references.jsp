...
%><vel:velocity><html>
    <head>
        <title><? webapp/imcms/lang/jsp/document_references.jsp/heading ?></title>
        <link rel="stylesheet" type="text/css" href="$contextPath/imcms/css/imcms_admin.css.jsp">
        <script type="text/javascript" src="$contextPath/imcms/scripts/imcms_api.js"></script>
    </head>
    <body>
        #gui_outer_start()
        #gui_head( '<? webapp/imcms/lang/jsp/document_references.jsp/heading ?>' )
        ...
        <table border="0" cellspacing="0" cellpadding="2" width="400">
            <tr>
                <td colspan="2">#gui_heading( '<? webapp/imcms/lang/jsp/document_references.jsp/explanation ?>' )</td>
            </tr>
            <tr>
                <td width="15%" align="center"><b><? webapp/imcms/lang/jsp/heading_status ?>&nbsp;</b></td>
                <td width="85%"><b><? webapp/imcms/lang/jsp/heading_adminlink ?></b></td>
            </tr>
        <%
            ...
            <tr>
                ...
                <td>
                    <a href="<%= request.getContextPath() %>/servlet/AdminDoc?meta_id=<%= textDocument.getId() %>&<%= AdminDoc.PARAMETER__DISPATCH_FLAGS %>=<%= ImcmsConstants.DISPATCH_FLAG__EDIT_MENU %>&editmenu=<%= menuIndex %>">
                        ...
                        -
                        <? webapp/imcms/lang/jsp/document_references.jsp/heading_menu ?> <%= menuIndex %>
                    </a>
                </td>
            </tr>
        <% } %>
