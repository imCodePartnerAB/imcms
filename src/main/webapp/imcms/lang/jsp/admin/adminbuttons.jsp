...
<tr>
	...
	<tr><%
        ...
        <td><%= href_0 %><img src="${contextPath}/imcms/images/icons/flags_iso_639_1/<%= langCode %>.gif" alt=""
                              style="border:0;"/><%= href_1 %>
        </td>
...
<tr>
	<td class="adminPanelTd2" align="center" nowrap>
        <a href="${contextPath}/servlet/BackDoc" id="admHrefBackdoc"><img
                src="${contextPath}/imcms/${language}/images/admin/adminbuttons/foregaende.gif"<%
        ...
        if (user.canEdit( document )) {
    %><a href="<%= Utility.getAbsolutePathToDocument( request, document ) %>" id="admHrefNormal"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/normal.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=65536" id="admHrefText"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/btn_text.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=2097152" id="admHrefText"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/btn_contentloop.gif"<%
              %> alt="ContentLoop"<%
              %> title="ContentLoop" id="admBtnGroup" border="0" /></a><%                            
            }
            if( textDocumentPermissionSet.getEditImages()  && isWorkingVersion) {
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=131072" id="admHrefBild"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/btn_image.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=262144" id="admHrefLank"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/meny.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=524288" id="admHrefUtseende"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/utseende.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=1048576" id="admHrefInclude"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/include.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=65536" id="admHrefRedigera"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/redigera.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=1"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/dokinfo.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminDoc?meta_id=<%= document.getId() %>&flags=4" id="admHrefRattigheter"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/rattigheter.gif"<%
    ...
    %><a href="${contextPath}/servlet/LogOut" id="admHrefLoggaut"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/loggaut.gif"<%
    ...
    %><a href="${contextPath}/servlet/AdminManager" target="_blank" id="admHrefAdmin"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/admin.gif"<%
    ...
    %><a href="javascript:void(0)" onClick="openHelpW('HelpStart');return(false)" target="_blank" id="admHrefHelp"><img
            src="${contextPath}/imcms/${language}/images/admin/adminbuttons/help.gif"<%
