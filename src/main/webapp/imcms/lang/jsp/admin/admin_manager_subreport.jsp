...
<table border="0" cellspacing="0" cellpadding="2" width="656">
	...
	<tr>
		<td><span class="imcmsAdmHeading">
			<%= StringEscapeUtils.escapeHtml4(subreportHeading.toLocalizedString(request)) %>
			<br>(<%= documents.size() %> <? webapp/imcms/lang/jsp/admin/admin_manager.jsp/10 ?>)</span></td>
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<% if (subreport.isExpanded()) { %>
					<input type="hidden" name="<%= subreportName %>_expand" value="1">
					<td><input type="submit" class="imcmsFormBtnSmall" name="<%= subreportName %>_unexpand"
							   value="<? webapp/imcms/lang/jsp/admin/admin_manager.jsp/12 ?> &raquo;"></td>
					<%} else { %>
					<td><input type="submit" class="imcmsFormBtnSmall" name="<%= subreportName %>_expand"
							   value="<? webapp/imcms/lang/jsp/admin/admin_manager.jsp/11 ?> &raquo;"></td>
					<%}%>
				</tr>
			</table>
		</td>
		...
		<td colspan="2">
			<table border="0" cellspacing="0" cellpadding="2" width="100%">
				<tr valign="bottom">
					...
					<td width="40"><b><? webapp/imcms/lang/jsp/admin/admin_manager.jsp/16 ?></b>&nbsp;</td>
					<td><b><? webapp/imcms/lang/jsp/admin/admin_manager.jsp/15 ?></b></td>
					<td><b><? webapp/imcms/lang/jsp/admin/admin_manager.jsp/21 ?></b></td>
					<td><b><? webapp/imcms/lang/jsp/admin/admin_manager.jsp/17 ?>
						/<? webapp/imcms/lang/jsp/admin/admin_manager.jsp/18 ?></b></td>
					<td align="right" nowrap>
						<input type="submit" class="imcmsFormBtnSmall"
							   value="<? webapp/imcms/lang/jsp/admin/admin_manager_search.jsp/7 ?>">
						&nbsp;
						<select name="<%= subreportName %>_sortorder" onChange="this.form.submit();">
				...
				<jsp:useBean id="listItemBean" class="com.imcode.imcms.servlet.beans.AdminManagerSubReportListItemBean"
							 scope="request"/>
	...
	<tr>
		<td colspan="4" align="center"><img src="<%= imagesPath %>1x1.gif" height="20" width="1"><br>
			<a href="<%= request.getContextPath() %>/servlet/AdminManager?show=search&<%= searchQueryString %>"><? webapp/imcms/lang/jsp/admin/admin_manager.jsp/19 ?></a>
		</td>
	</tr>
