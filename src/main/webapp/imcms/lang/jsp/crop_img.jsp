            ...
            <div id="outer_container">
                <div id="inner_container">
                    ...
                    <form method="post" action="${contextPath}/servlet/PageDispatcher">
                        ...
                        <input type="hidden" name="${const.PARAM_ROTATE_ANGLE}" value="${rotateDirection.angle}"/>
                        #gui_mid()
                                ...
                                <td>
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td>
                                                <label for="crop_x1">
                                                    <b><? webapp/imcms/lang/jsp/crop_img.jsp/x1 ?></b>
                                                </label>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td>
                                                <label for="crop_y1">
                                                    <b><? webapp/imcms/lang/jsp/crop_img.jsp/y1 ?></b>
                                                </label>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td>
                                                <label for="crop_x2">
                                                    <b><? webapp/imcms/lang/jsp/crop_img.jsp/x2 ?></b>
                                                </label>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td>
                                                <label for="crop_y2">
                                                    <b><? webapp/imcms/lang/jsp/crop_img.jsp/y2 ?></b>
                                                </label>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td>
                                                <label for="width">
                                                    <b><? webapp/imcms/lang/jsp/crop_img.jsp/width ?></b>
                                                </label>
                                            </td>
                                            <td></td>
                                            <td>
                                                <label for="height">
                                                    <b><? webapp/imcms/lang/jsp/crop_img.jsp/height ?></b>
                                                </label>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td><input type="submit" class="imcmsFormBtnSmall" name="${const.REQUEST_PARAMETER__ROTATE_LEFT}" value="<? webapp/imcms/lang/jsp/crop_img.jsp/rotate_left ?>"/></td>
                                            <td>&nbsp;</td>
                                            <td><input type="submit" class="imcmsFormBtnSmall" name="${const.REQUEST_PARAMETER__ROTATE_RIGHT}" value="<? webapp/imcms/lang/jsp/crop_img.jsp/rotate_right ?>"/></td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="right">
                                    <input type="submit" class="imcmsFormBtn" name="${const.REQUEST_PARAMETER__OK}" value=" <? webapp/imcms/lang/jsp/crop_img.jsp/crop ?> "/>
                                    <input type="submit" class="imcmsFormBtn" name="${const.REQUEST_PARAMETER__CANCEL}" value=" <? webapp/imcms/lang/jsp/crop_img.jsp/cancel ?> "/>
                                </td>
                            </tr>
                        </table>
                    </form>
