...
%>
    ...
    <c:set var="heading">
        <fmt:message key="templates/sv/AdminManager_adminTask_element.htm/17"/>
    </c:set>
            ...
            <tr>
                <td>
                    ...
                    <input type="button" value="<? global/help ?>" title="<? global/help ?>" class="imcmsFormBtn"
                           onClick="openHelpW('CategoryAdmin')"></td>
            </tr>
        </form>
        <tr>
	...
	inDeleteCategoryTypeMode ? "Disabled\" disabled" : "\"" %> name="<%=
                AdminCategories.PARAMETER_MODE__DELETE_CATEGORY_TYPE %>" value="<? global/remove ?>">
                </td>
            </tr>
            <tr>
	...
	inViewCategoryMode ? "Disabled\" disabled" : "\"" %> name="<%=
                AdminCategories.PARAMETER_MODE__VIEW_CATEGORY %>" value="<? global/view ?>">
                </td>
            </tr>
        </form>
    </table>
            ...
            <tr>
                <td colspan="2">
                    <table border="0" cellpadding="0" cellspacing="0" width="656">
                        ...
                        <tr>
                            <td colspan="2" height="24" class="imcmsAdmText"><font
                                    face="Verdana, Arial, Helvetica, sans-serif" size="1"
                                    color="red"><%=messageToUser %>
                            </font></td>
                        </tr>
                        <%}%>
                        ...
                        <tr>
                            <td width="110" height="24" class="imcmsAdmText"
                                nowrap><? install/htdocs/sv/jsp/category_admin/category_type ?> &nbsp;
                            </td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td><input type="submit" class="imcmsFormBtnSmall"
                                                   name="<%= AdminCategories.PARAMETER_BUTTON__SELECT_CATEGORY_TYPE_TO_SHOW_OR_REMOVE %>"
                                                   value="<? global/select ?>"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <input type="hidden" name="oldName"
                               value="<%=adminCategoriesPage.getCategoryToEdit() != null ? adminCategoriesPage.getCategoryToEdit().getName() : "" %>">
                        ...
                        <tr>
                            <td width="110" height="24" class="imcmsAdmText"
                                nowrap><? install/htdocs/sv/jsp/category_admin/category ?> &nbsp;
                            </td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td>&nbsp;&nbsp;</td>
                                        <td><input type="submit" class="imcmsFormBtnSmall"
                                                   name="select_category_to_edit" value="<? global/select ?>"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <% if (categoryTypeToEdit != null) { %>
                        <tr>
                            <td class="imcmsAdmText" nowrap><? install/htdocs/sv/jsp/category_admin/category ?> &nbsp;
                            </td>
                            <td>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                        ...
                        %>
                        <input type="hidden" name="<%= AdminCategories.PARAMETER_MODE__DELETE_CATEGORY_TYPE %>"
                               value="1">
                        <tr>
                            <td width="110" height="24" class="imcmsAdmText"
                                nowrap><? install/htdocs/sv/jsp/category_admin/category_type ?> &nbsp;
