...
<%
    ...
    textDocument.setHeadline(DocumentLanguages.getCurrentLanguage(), "Textdocument created from API" );
...
<%
    ...
    urlDocument.setHeadline(DocumentLanguages.getCurrentLanguage(),  "URL-document created from API" );
...
<%
    ...
    fileDocument.setHeadline(DocumentLanguages.getCurrentLanguage(),  "Filedocument created from API");
