...
<div style="width:310px;">
    ...
    <form method="POST" action="<%= request.getContextPath() %>/servlet/PasswordReset">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td width="50%" style="white-space:nowrap;"><%=formLabelPassword.toLocalizedString(request)%>
                </td>
            ...
            <tr>
                <td colspan="2" align="right" style="padding-top:10px;"><input type="submit" class="imcmsFormBtnSmall"
                                                                               value="<%=formSubmit.toLocalizedString(request)%>"/>
                </td>
            </tr>
        </table>
    </form>
