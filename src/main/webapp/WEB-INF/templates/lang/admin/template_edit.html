...
<tr>
	...
	<input type="button" value="<? global/help ?>" title="<? global/help ?>" class="imcmsFormBtn" onClick="openHelpW('TemplateEdit')"></td>
</tr>
</form>
<tr>
...
<tr>
	<td>
	<input type="submit" class="imcmsFormBtnSub" name="add_template" value="<? templates/sv/template_edit.html/2001 ?>">
	<input type="submit" class="imcmsFormBtnSub" name="delete_template" value="<? templates/sv/template_edit.html/2002 ?>">
...
<tr>
	<td>
	<input type="submit" class="imcmsFormBtnSub" name="add_group" value="<? templates/sv/template_edit.html/2008 ?>">
	<input type="submit" class="imcmsFormBtnSub" name="delete_group" value="<? templates/sv/template_edit.html/2009 ?>">
	<input type="submit" class="imcmsFormBtnSub" name="rename_group" value="<? templates/sv/template_edit.html/2010 ?>">
	<input type="submit" class="imcmsFormBtnSub" name="assign_group" value="<? templates/sv/template_edit.html/2011 ?>"></td>
</tr>
</form>
</table>
#gui_mid()
...
<tr>
	<td colspan="2">#gui_heading( "<? templates/sv/template_edit.html/4 ?>" )</td>
</tr>
<tr>
	<td colspan="2">
...
<tr>
	...
	<input type="button" class="imcmsFormBtn" name="template_edit" value="<? templates/sv/template_edit.html/2014 ?>" onClick="editFile(); return false">
	<input type="button" class="imcmsFormBtn" name="back" value="<? templates/sv/template_edit.html/2015 ?>" onClick="document.location = 'TemplateAdmin'; return false"></td>
</tr>
</form>
</table>
#gui_bottom()
