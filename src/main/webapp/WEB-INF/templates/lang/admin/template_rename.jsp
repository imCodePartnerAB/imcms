    ...
    <form name="TemplateChange" action="TemplateChange" method="post">
        ...
        <tr>
            <td colspan="2">
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td height="24" class="imcmsAdmText" nowrap><? templates/sv/template_rename.html/1002 ?>
                            &nbsp;
                        </td>
                        <td><input type="text" name="name" size="30" maxlength="255"> <span
        ...
        <tr>
            <td colspan="2" align="right">
                <input type="submit" class="imcmsFormBtn" name="template_rename"
                       value="<? templates/sv/template_rename.html/2014 ?>">
