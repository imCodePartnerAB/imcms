...
<tr>
    <td>
        ...
        <input type="submit" class="imcmsFormBtnSubDisabled" name="rename_template" value="<? templates/sv/template_rename.html/2003 ?>" disabled="disabled">
        ...
        <input type="submit" class="imcmsFormBtnSub" name="change_availability_template" value="<? templates/sv/template_admin.html/2012 ?>">
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="2">#gui_heading( "<? templates/sv/template_rename.html/6/1 ?>" )</td>
</tr>
<tr>
    <td colspan="2">
...
<tr>
    <td colspan="2" align="right">
        <input type="submit" class="imcmsFormBtn" name="template_rename" value="<? templates/sv/template_rename.html/2014 ?>">
