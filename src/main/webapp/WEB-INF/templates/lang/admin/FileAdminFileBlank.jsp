...
<input type="HIDDEN" name="dir2" value="#dir2#">
<tr>
    <td>#gui_heading( "<? templates/sv/FileAdminFileBlank.html/2 ?>" )</td>
</tr>
<tr>
...
<tr>
    <td align="right"><input type="submit" class="imcmsFormBtn" style="width:70" name="no" value="<? templates/sv/FileAdminFileBlank.html/2001 ?>"></td>
</tr>
</form>
</table>
<ui:imcms_gui_bottom/>
