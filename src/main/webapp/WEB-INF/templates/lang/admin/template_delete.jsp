        ...
        <tr>
            <td>
                <input type="submit" class="imcmsFormBtnSub" name="add_template"
                       value="<? templates/sv/template_delete.html/2001 ?>">
                <input type="submit" class="imcmsFormBtnSubDisabled" name="delete_template"
                       value="<? templates/sv/template_delete.html/2002 ?>" disabled="disabled">
                <input type="submit" class="imcmsFormBtnSub" name="rename_template"
                       value="<? templates/sv/template_delete.html/2003 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="get_template"
                       value="<? templates/sv/template_delete.html/2004 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="edit_template"
                       value="<? templates/sv/template_delete.html/2005 ?>"><br>
                ...
                <input type="submit" class="imcmsFormBtnSub" name="add_demotemplate"
                       value="<? templates/sv/template_delete.html/2006 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="show_templates"
                       value="<? templates/sv/template_delete.html/2007 ?>">
