...
<tr>
    <td>
        ...
        <input type="button" value="<? global/help ?>" title="<? global/help ?>" class="imcmsFormBtn" onClick="openHelpW('TemplateUploadNew')"></td>
</tr>
</form>
<tr>
...
<tr>
    <td>
        <input type="submit" class="imcmsFormBtnSubDisabled" name="add_template" value="<? templates/sv/template_upload.html/2001 ?>" disabled="disabled">
        <input type="submit" class="imcmsFormBtnSub" name="delete_template" value="<? templates/sv/template_upload.html/2002 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="rename_template" value="<? templates/sv/template_upload.html/2003 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="get_template" value="<? templates/sv/template_upload.html/2004 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="edit_template" value="<? templates/sv/template_upload.html/2005 ?>"><br>
        <img src="$contextPath/imcms/$language/images/admin/1x1.gif" width="1" height="2"><br>
        <input type="submit" class="imcmsFormBtnSub" name="add_demotemplate" value="<? templates/sv/template_upload.html/2006 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="show_templates" value="<? templates/sv/template_upload.html/2007 ?>">
...
<tr>
    <td>
        <input type="submit" class="imcmsFormBtnSub" name="add_group" value="<? templates/sv/template_upload.html/2008 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="delete_group" value="<? templates/sv/template_upload.html/2009 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="rename_group" value="<? templates/sv/template_upload.html/2010 ?>">
        <input type="submit" class="imcmsFormBtnSub" name="assign_group" value="<? templates/sv/template_upload.html/2011 ?>"></td>
</tr>
</form>
</table>
<ui:imcms_gui_mid/>
...
<tr>
    <td colspan="2" align="right">
        <input type="submit" class="imcmsFormBtn" name="ok" value="<? templates/sv/template_upload.html/2014 ?>">
        <input type="submit" class="imcmsFormBtn" name="cancel" value="<? templates/sv/template_upload.html/2015 ?>"></td>
</tr>
</form>
</table>
<ui:imcms_gui_bottom/>
