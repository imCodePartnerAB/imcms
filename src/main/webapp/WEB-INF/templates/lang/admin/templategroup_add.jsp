...
<table border="0" cellspacing="0" cellpadding="2" width="660" align="center">
        ...
        <tr>
            <td>
                ...
                <input type="button" value="<? global/help ?>" title="<? global/help ?>" class="imcmsFormBtn"
                       onClick="openHelpW('TemplateGroupCreate')"></td>
        </tr>
    </form>
    <tr>
    ...
    <form name="TemplateAdmin" action="TemplateAdmin" method="post">
        ...
        <tr>
            <td>
                ...
                <input type="submit" class="imcmsFormBtnSub" name="add_demotemplate"
                       value="<? templates/sv/templategroup_add.html/2006 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="show_templates"
                       value="<? templates/sv/templategroup_add.html/2007 ?>">
        ...
        <tr>
            <td>
                <input type="submit" class="imcmsFormBtnSubDisabled" name="add_group"
                       value="<? templates/sv/templategroup_add.html/2008 ?>" disabled="disabled">
                <input type="submit" class="imcmsFormBtnSub" name="delete_group"
                       value="<? templates/sv/templategroup_add.html/2009 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="rename_group"
                       value="<? templates/sv/templategroup_add.html/2010 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="assign_group"
                       value="<? templates/sv/templategroup_add.html/2011 ?>"></td>
        </tr>
    </form>
</table>
<ui:imcms_gui_mid/>
    ...
    <form name="TemplateChange" action="TemplateChange" method="post">
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="80" height="24" class="imcmsAdmText"
                            nowrap><? templates/sv/templategroup_add.html/1001 ?> &nbsp;
                        </td>
        ...
        <tr>
            <td colspan="2" align="right">
                <input type="submit" class="imcmsFormBtn" name="group_add"
                       value="<? templates/sv/templategroup_add.html/2014 ?>">
                <input type="submit" class="imcmsFormBtn" name="cancel"
                       value="<? templates/sv/templategroup_add.html/2015 ?>"></td>
        </tr>
    </form>
</table>
<ui:imcms_gui_bottom/>
