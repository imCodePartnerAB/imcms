        ...
        <tr>
            <td>
                ...
                <input type="button" value="<? global/help ?>" title="<? global/help ?>" class="imcmsFormBtn"
                       onClick="openHelpW('TemplateDownload')"></td>
        </tr>
    </form>
    <tr>
        ...
        <tr>
            <td>
                <input type="submit" class="imcmsFormBtnSub" name="add_template"
                       value="<? templates/sv/template_get.html/2001 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="delete_template"
                       value="<? templates/sv/template_get.html/2002 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="rename_template"
                       value="<? templates/sv/template_get.html/2003 ?>">
                <input type="submit" class="imcmsFormBtnSubDisabled" name="get_template"
                       value="<? templates/sv/template_get.html/2004 ?>" disabled="disabled">
                <input type="submit" class="imcmsFormBtnSub" name="edit_template"
                       value="<? templates/sv/template_get.html/2005 ?>"><br>
                ...
                <input type="submit" class="imcmsFormBtnSub" name="add_demotemplate"
                       value="<? templates/sv/template_get.html/2006 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="show_templates"
                       value="<? templates/sv/template_get.html/2007 ?>">
    ...
    <form action="TemplateChange" method="post">
        ...
        <tr>
            <td colspan="2">
                <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="80" height="24" class="imcmsAdmText" nowrap><? templates/sv/template_get.html/1001 ?>
                            &nbsp;
                        </td>
                        <td>
        ...
        <tr>
            <td colspan="2" align="right">
                <input type="submit" class="imcmsFormBtn" name="template_get"
                       value="<? templates/sv/template_get.html/2014 ?>">
                <input type="button" class="imcmsFormBtn" name="back" value="<? templates/sv/template_get.html/2015 ?>"
