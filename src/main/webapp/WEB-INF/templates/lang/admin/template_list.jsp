        ...
        <tr>
            <td>
                ...
                <input type="button" value="<? global/help ?>" title="<? global/help ?>" class="imcmsFormBtn"
                       onClick="openHelpW('TemplateList')"></td>
        </tr>
    </form>
    <tr>
        ...
        <tr>
            <td>
                ...
                <input type="submit" class="imcmsFormBtnSub" name="add_demotemplate"
                       value="<? templates/sv/template_list.html/2006 ?>">
                <input type="submit" class="imcmsFormBtnSubDisabled" name="show_templates"
                       value="<? templates/sv/template_list.html/2007 ?>" disabled="disabled">
        ...
        <tr>
            <td>
                <input type="submit" class="imcmsFormBtnSub" name="add_group"
                       value="<? templates/sv/template_list.html/2008 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="delete_group"
                       value="<? templates/sv/template_list.html/2009 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="rename_group"
                       value="<? templates/sv/template_list.html/2010 ?>">
                <input type="submit" class="imcmsFormBtnSub" name="assign_group"
                       value="<? templates/sv/template_list.html/2011 ?>"></td>
        </tr>
    </form>
</table>
<ui:imcms_gui_mid/>
...
<table border="0" cellspacing="0" cellpadding="2" width="660" align="center">
    <form name="TemplateChange" action="TemplateChange" method="post">
        ...
        <tr>
            <td colspan="2">
                <c:set var="heading">
                    <fmt:message key="templates/sv/template_list.html/6/1"/>
                </c:set>
            ...
            <td colspan="2">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            &nbsp;<input type="submit" class="imcmsFormBtnSmall" name="list_templates_docs"
                                         value="<? templates/sv/template_list.html/2014 ?>"
                                         alt="<? templates/sv/template_list.html/2015 ?>"
                                         title="<? templates/sv/template_list.html/2016 ?>" style="width:70">&nbsp;
                        </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">&nbsp;</td>
                        <td><input type="submit" class="imcmsFormBtnSmall" name="show_doc"
                                   value="<? templates/sv/template_list.html/2017 ?>"></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2" align="right">
                <input type="submit" class="imcmsFormBtn" name="cancel"
                       value="<? templates/sv/template_list.html/2018 ?>"></td>
        </tr>
    </form>
</table>
<ui:imcms_gui_bottom/>
