...
<form method="post" action="FileAdmin" enctype="multipart/form-data">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td><input class="imcmsFormBtn" height="22" type="submit" name="cancel"
                       value="<? templates/sv/FileAdmin.html/2022 ?>">
                <input class="imcmsFormBtn" type="button" value="<? global/help ?>"
                       onClick="openHelpW('FileManager'); return false;"></td>
        </tr>
    </table>
    <ui:imcms_gui_mid/>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="760" align="center">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="right"><input
                                type="submit" name="change1" class="imcmsFormBtnSmall" height="22"
                                value="<? templates/sv/FileAdmin.html/2001 ?>"></td>
                    </tr>
                    <tr>
                        <td><img src="${contextPath}/imcms/${language}/images/admin/1x1.gif" width="1" height="2"
                                 alt=""></td>
                    </tr>
                    <tr>
		...
		<select name="files1" id="fileSel_1" size="20" class="imcmsAdmForm" style="width:330px"
            ...
            <td colspan="2" align="center">
                <table border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr>
                        <td align="right"><input class="imcmsFormBtnSmall" height="22" type="submit" name="delete1"
                                                 value="&nbsp;<? templates/sv/FileAdmin.html/2002 ?>&nbsp;"></td>
                        <td><input class="imcmsFormBtnSmall" height="22" type="submit" name="delete2"
                                   value="&nbsp;<? templates/sv/FileAdmin.html/2003 ?>&nbsp;"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right"><input class="imcmsFormBtnSmall" height="22" type="submit" name="move2"
                                                 value="<? templates/sv/FileAdmin.html/2004 ?>"></td>
                        <td><input class="imcmsFormBtnSmall" height="22" type="submit" name="move1"
                                   value="<? templates/sv/FileAdmin.html/2005 ?>"></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" class="small">
                            <img src="${contextPath}/imcms/${language}/images/admin/line_hr2.gif" width="50" height="6"
                    ...
                    <tr>
                        <td align="right"><input class="imcmsFormBtnSmall" height="22" type="submit" name="copy2"
                                                 value="&nbsp;<? templates/sv/FileAdmin.html/2006 ?>&nbsp;"></td>
                        <td><input class="imcmsFormBtnSmall" height="22" type="submit" name="copy1"
                                   value="&nbsp;<? templates/sv/FileAdmin.html/2007 ?>&nbsp;"></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" class="small">
                            <img src="${contextPath}/imcms/${language}/images/admin/line_hr2.gif" width="50" height="6"
                    ...
                    <tr>
                        <td align="right"><input class="imcmsFormBtnSmall" height="22" type="submit" name="download1"
                                                 value="&nbsp;<? templates/sv/FileAdmin.html/2008 ?>&nbsp;"></td>
                        <td><input class="imcmsFormBtnSmall" height="22" type="submit" name="download2"
                                   value="&nbsp;<? templates/sv/FileAdmin.html/2009 ?>&nbsp;"></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" class="small">
                            <img src="${contextPath}/imcms/${language}/images/admin/line_hr2.gif" width="50" height="6"
                    ...
                    <tr>
                        <td align="right"><input class="imcmsFormBtnSmall" height="22" type="button" name="preview1"
                                                 value="&nbsp;<? templates/sv/FileAdmin.html/2010 ?>&nbsp;"
                                                 onClick="previewFile(1)"></td>
                        <td><input class="imcmsFormBtnSmall" height="22" type="button" name="preview2"
                                   value="&nbsp;<? templates/sv/FileAdmin.html/2011 ?>&nbsp;" onClick="previewFile(2)">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" class="small">
                    ...
                    <tr>
                        <td align="right"><input class="imcmsFormBtnSmall" height="22" type="button" name="edit1"
                                                 value="&nbsp;<? templates/sv/FileAdmin.html/2012 ?>&nbsp;"
                                                 onClick="editFile(1,0);"></td>
                        <td><input class="imcmsFormBtnSmall" height="22" type="button" name="edit2"
                                   value="&nbsp;<? templates/sv/FileAdmin.html/2013 ?>&nbsp;" onClick="editFile(2,0);">
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td><input type="submit" name="change2"
                                   class="imcmsFormBtnSmall" height="22" value="<? templates/sv/FileAdmin.html/2014 ?>">
                        </td>
                    </tr>
                    <tr>
                        <td><img src="${contextPath}/imcms/${language}/images/admin/1x1.gif" width="1" height="2"
        ...
        <tr>
            <td colspan="6"><img src="${contextPath}/imcms/${language}/images/admin/1x1.gif" width="1" height="8"
                                 alt=""></td>
        </tr>
        <tr>
    ...
    <input type="file" name="file" class="imcmsAdmForm" size="20"></span></td>
            <td align="right"><input class="imcmsFormBtnSmall" height="22" style="width:90px" type="submit"
                                     name="upload2"
        ...
        <tr>
            ...
            <td colspan="2"><img src="${contextPath}/imcms/${language}/images/admin/1x1.gif" width="80" height="1"
                                 alt=""></td>
            <td><img src="${contextPath}/imcms/${language}/images/admin/1x1.gif" width="180" height="1" alt=""></td>
            <td><img src="${contextPath}/imcms/${language}/images/admin/1x1.gif" width="150" height="1" alt=""></td>
        </tr>
