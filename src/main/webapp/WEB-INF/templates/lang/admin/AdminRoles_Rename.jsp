...
#gui_start_of_page( "<? templates/sv/AdminRoles_Rename.htm/1 ?>" "AdminRoles" "CANCEL_ROLE" "RoleChangeName" "" )
...
<tr>
    <td class="imcmsAdmText">
        #gui_heading( "<? templates/sv/AdminRoles_Rename.htm/3 ?> &nbsp; &nbsp; <i>#CURRENT_ROLE_NAME#</i>" )</td>
</tr>
<tr>
    <td>
