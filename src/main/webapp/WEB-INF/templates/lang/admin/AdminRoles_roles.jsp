...
<form method="post" action="AdminRoles" name="UserInfo">
    <table border="0" cellspacing="0" cellpadding="2" width="400">
        ...
        <tr>
            <td>
                <input type="submit" class="imcmsFormBtnSmall" name="VIEW_ADD_NEW_ROLE"
                       value="<? templates/sv/AdminRoles_roles.htm/2001 ?>">
                <input type="submit" class="imcmsFormBtnSmall" name="VIEW_RENAME_ROLE"
                       value="<? templates/sv/AdminRoles_roles.htm/2002 ?>">
                <input type="submit" class="imcmsFormBtnSmall" name="VIEW_EDIT_ROLE"
                       value="<? templates/sv/AdminRoles_roles.htm/2003 ?>">
                <input type="submit" class="imcmsFormBtnSmall" name="VIEW_DELETE_ROLE"
                       value="<? templates/sv/AdminRoles_roles.htm/2004 ?>"></td>
        </tr>
    </table>
</form>
