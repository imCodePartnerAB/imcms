...
function openHelpW(id){
    var helpMetaId = parseInt(<? helpDocumentationMetaIdStartIndex ?>) + id;
...
function imcmsGui(type, heading) {
	...
	switch (type) {
		...
		case "outer_end":
			retVal = "</td>\n";
			retVal += "	<td align=\"right\" valign=\"top\" background=\"@imcmsimageurl@/admin/imcms_admin_shadow_right.gif\"><img src=\"@imcmsimageurl@/admin/imcms_admin_shadow_right_top.gif\" width=\"12\" height=\"12\" alt=\"\" border=\"0\"></td>\n";
			retVal += "</tr>\n";
			retVal += "<tr>\n";
			retVal += "	<td colspan=\"2\">\n";
			retVal += "	<table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\">\n";
			retVal += "	<tr>\n";
			retVal += "		<td background=\"@imcmsimageurl@/admin/imcms_admin_shadow_bottom.gif\">\n";
			retVal += "		<img src=\"@imcmsimageurl@/admin/imcms_admin_shadow_bottom_left.gif\" width=\"12\" height=\"12\" alt=\"\" border=\"0\"></td>\n";
			retVal += "		<td background=\"@imcmsimageurl@/admin/imcms_admin_shadow_bottom.gif\" align=\"right\">\n";
			retVal += "		<img src=\"@imcmsimageurl@/admin/imcms_admin_shadow_bottom_right.gif\" width=\"12\" height=\"12\" alt=\"\" border=\"0\"></td>\n";
			retVal += "	</tr>\n";
			retVal += "	</table></td>\n";
			retVal += "</tr>\n";
			retVal += "</table>";
		...
		case "head":
			...
			retVal += "<tr>\n";
			retVal += "	<td class=\"imcmsAdmBgHead\" colspan=\"6\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"20\"></td>\n";
			retVal += "</tr>\n";
			retVal += "<tr class=\"imcmsAdmBgHead\">\n";
			retVal += "	<td colspan=\"2\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td nowrap><span class=\"imcmsAdmHeadingTop\">" + sHeading + "</span></td>\n";
			retVal += "	<td align=\"right\"><a href=\"http://www.imcms.net/\" target=\"_blank\"><img src=\"@imcmsimageurl@/admin/logo_imcms_admin.gif\" width=\"100\" height=\"20\" alt=\"www.imcms.net\" border=\"0\"></a></td>\n";
			retVal += "	<td colspan=\"2\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "</tr>\n";
			retVal += "<tr>\n";
			retVal += "	<td class=\"imcmsAdmBgHead\" colspan=\"6\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"20\"></td>\n";
		...
		case "mid":
			...
			retVal += "</tr>\n";
			retVal += "<tr>\n";
			retVal += "	<td height=\"10\" class=\"imcmsAdmBorder\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td class=\"imcmsAdmBgCont\" colspan=\"4\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td class=\"imcmsAdmBorder\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "</tr>\n";
			retVal += "<tr class=\"imcmsAdmBgCont\">\n";
			retVal += "	<td class=\"imcmsAdmBorder\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td colspan=\"2\">";
		break;
		case "mid_noshade":
			retVal = "</td>\n";
			...
			retVal += "</tr>\n";
			retVal += "<tr>\n";
			retVal += "	<td height=\"10\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td class=\"imcmsAdmBgCont\" colspan=\"4\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "</tr>\n";
			retVal += "<tr class=\"imcmsAdmBgCont\">\n";
		...
		case "bottom":
			...
			retVal += "<tr class=\"imcmsAdmBgCont\">\n";
			retVal += "	<td><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"24\" height=\"1\"></td>\n";
			retVal += "	<td colspan=\"2\"><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "	<td><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"24\" height=\"1\"></td>\n";
			retVal += "	<td><img src=\"@imcmsimageurl@/admin/1x1.gif\" width=\"1\" height=\"1\"></td>\n";
			retVal += "</tr>\n";
