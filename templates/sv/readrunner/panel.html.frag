...
<DIV ID="RRpanelDiv" style="position:absolute; left:-1000; top:-1000; width:249; height:36; clip:rect(0px 249px 36px 0px); padding:0; margin:0; z-index:10; display:block"><input type="image" name="stop" id="stop2" title="<? sv/readrunner/panel.html.frag/2001 ?>" value="Stop" onClick="return false" disabled="disabled" src="@readrunnerimagesurl@/btn_panel_stopp.gif" width="57" height="13" style="visibility:hidden"><input type="image" name="start" id="start" title="<? sv/readrunner/panel.html.frag/2002 ?>" value="Go!" onClick="return false" disabled="disabled" src="@readrunnerimagesurl@/btn_panel_start.gif" width="57" height="13" style="visibility:hidden"></DIV>
